...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x14184e => _0x14184e.style.color = '#fff');
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x395aaf => _0x395aaf.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x347c9a) {
  if (_0x347c9a.innerText === '▼') {
...
function toggleHideControlBot(_0x265865) {
  if (_0x265865.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x41c342 = '';
  coins.map(_0x5b5f19 => {
    _0x41c342 += "<option value=\"" + _0x5b5f19 + "\">" + _0x5b5f19 + "</option>";
  });
  document.getElementById('wdbMenuCoin').innerHTML = _0x41c342;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x8b7ec3 = document.createElement("div");
  _0x8b7ec3.id = "wdbWrap";
  _0x8b7ec3.innerHTML = wdbUI;
  document.body.prepend(_0x8b7ec3);
  const _0x2ab506 = document.getElementById("wdb");
  let _0x3aabfa = 0x0;
  let _0x25d19e = 0x0;
  let _0x1d659c = 0x0;
  let _0x4f7fab = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x426a1c;
  } else {
    _0x2ab506.onmousedown = _0x426a1c;
  }
  if (document.getElementById("wdbFooter")) {
    document.getElementById("wdbFooter").onmousedown = _0x426a1c;
  } else {
    _0x2ab506.onmousedown = _0x426a1c;
  }
  function _0x426a1c(_0x2f51e0) {
    _0x2f51e0 = _0x2f51e0 || window.event;
    _0x2f51e0.preventDefault();
    _0x1d659c = _0x2f51e0.clientX;
    _0x4f7fab = _0x2f51e0.clientY;
    document.onmouseup = _0x5480b3;
    document.onmousemove = _0x1bde35;
  }
  function _0x1bde35(_0x273b70) {
    _0x273b70 = _0x273b70 || window.event;
    _0x273b70.preventDefault();
    _0x3aabfa = _0x1d659c - _0x273b70.clientX;
    _0x25d19e = _0x4f7fab - _0x273b70.clientY;
    _0x1d659c = _0x273b70.clientX;
    _0x4f7fab = _0x273b70.clientY;
    _0x2ab506.style.top = _0x2ab506.offsetTop - _0x25d19e + 'px';
    _0x2ab506.style.left = _0x2ab506.offsetLeft - _0x3aabfa + 'px';
  }
  function _0x5480b3() {
  ...
  wdbTimer.addEventListener("secondsUpdated", () => {
    const _0xe84821 = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById("wdbTime").innerText = _0xe84821;
  });
  ...
  luaFileSelector.addEventListener("change", async _0xdd4531 => {
    const _0x52a804 = await new Response(_0xdd4531.target.files[0x0]).text();
    if (!_0x52a804) {
      return;
    }
    luaEditor.setValue(_0x52a804);
  });
  ...
  jsFileSelector.addEventListener("change", async _0x250c44 => {
    const _0x336767 = await new Response(_0x250c44.target.files[0x0]).text();
    if (!_0x336767) {
      return;
    }
    jsEditor.setValue(_0x336767);
  });
  drawChart();
}
async function wdbLoader(_0x336e7e, _0x5b7a39) {
  await _0x336e7e("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
  await _0x5b7a39("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
  await _0x5b7a39("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x336e7e("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x336e7e('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js');
  await _0x336e7e("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x336e7e(WDB_API + '/' + WDB_MODE + '/lib/chart.js');
  await _0x336e7e(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
  await _0x336e7e(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
  await _0x336e7e(WDB_API + '/' + WDB_MODE + "/lib/ms.js");
  await beforeWork(_0x336e7e);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log('Connected');
...
function selectFunction(_0x53efdd) {
  if (_0x53efdd === "resetall") {
    resetall();
  }
  if (_0x53efdd === "resetstats") {
    resetstats();
  }
  if (_0x53efdd === "resetchart") {
    toggleChart("reset");
  }
  if (_0x53efdd === "resethistory") {
    toggleHistory('clear');
  }
  if (_0x53efdd === "resetlog") {
    toggleLog('clear');
  }
  if (_0x53efdd === "resetseed") {
    resetseed();
  }
  if (_0x53efdd === 'stopchart') {
    toggleChart("stop");
  }
  if (_0x53efdd === "startchart") {
    toggleChart("start");
  }
  if (_0x53efdd === 'stophistory') {
    toggleHistory("stop");
  }
  if (_0x53efdd === 'starthistory') {
    toggleHistory("start");
  }
  if (_0x53efdd === "stoplog") {
    toggleLog("stop");
  }
  if (_0x53efdd === "startlog") {
    toggleLog("start");
  }
  if (_0x53efdd === "hidestats") {
    toggleStats("hide");
  }
  if (_0x53efdd === 'showstats') {
    toggleStats("show");
  }
  if (_0x53efdd === "hidechart") {
    toggleChart("hide");
  }
  if (_0x53efdd === "showchart") {
    toggleChart("show");
  }
  if (_0x53efdd === "hidehistory") {
    toggleHistory("hide");
  }
  if (_0x53efdd === "showhistory") {
    toggleHistory("show");
  }
}
function toggleMode(_0x309e4e) {
  mode = _0x309e4e;
  if (_0x309e4e === "lua") {
...
function toggleHistory(_0x51df0f) {
  if (_0x51df0f === "hide") {
...
function toggleLog(_0x496b31) {
  if (_0x496b31 === "stop") {
    stopLog = true;
  } else {
    if (_0x496b31 === 'start') {
      stopLog = false;
    } else if (_0x496b31 === 'clear') {
...
async function handleStats() {
  ...
  const _0x1f5fd5 = await updateStats();
  const _0x16c6a1 = await updateChart();
  const _0xb7c93a = await updateHistory();
  Promise.all([_0x1f5fd5, _0x16c6a1, _0xb7c93a]).then(async _0x5546ef => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x547a7c = profit === 0x0 ? darkMode ? "white" : 'black' : profit < 0x0 ? "red" : "green";
  const _0x153c11 = currentstreak === 0x0 ? darkMode ? 'white' : "black" : currentstreak < 0x0 ? "red" : "green";
  const _0x3e05b4 = maxwinstreak > 0x0 ? "green" : "black";
  document.getElementById('wdbHighWinStreak').style.color = _0x3e05b4;
  const _0x227e02 = maxlosestreak > 0x0 ? 'red' : "black";
  document.getElementById("wdbHighLoseStreak").style.color = _0x227e02;
  ...
  document.getElementById("wdbProfit").style.color = _0x547a7c;
  ...
  document.getElementById('wdbCurrentStreak').style.color = _0x153c11;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x547a7c;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x34f3e1 = game === "dice" ? bethigh ? '>' : '<' : '>';
    const _0x90ec95 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x14d5dd = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x59ed70 = '<td>' + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x90ec95 + "</td>\n      <td>" + (game === "plinko" ? _0x14d5dd : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x14d5dd : _0x34f3e1 + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0x21fbd3 = document.createElement('tr');
    if (win) {
      _0x21fbd3.style.backgroundColor = "#91f190";
    } else {
      _0x21fbd3.style.backgroundColor = "#ffc0cb";
    }
    _0x21fbd3.innerHTML = _0x59ed70;
    document.getElementById("wdbHistory").insertBefore(_0x21fbd3, document.getElementById("wdbHistory").children[0x0]);
    const _0x53d67b = document.querySelector("#wdbHistory").rows;
    if (_0x53d67b.length > maxRows) {
      document.querySelector("#wdbHistory").lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0xc508a2) {
  const _0x174c5f = document.getElementById('wdbLog');
  const _0x17e1bb = document.createElement('li');
  _0x17e1bb.innerText = '' + _0xc508a2;
  document.getElementById('wdbLog').insertBefore(_0x17e1bb, _0x174c5f.children[0x0]);
  const _0x22caaa = _0x174c5f.getElementsByTagName('li');
  if (_0x22caaa.length > maxRows) {
    document.getElementById("wdbLog").removeChild(_0x174c5f.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x452de9 => _0x452de9.disabled = true);
      document.querySelectorAll("#wdbOpenScript").forEach(_0x3c3a1b => _0x3c3a1b.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === "lua") {
        ...
        if (mode === 'js') {
          ...
          let _0x2e0287 = document.createElement('script');
          _0x2e0287.id = "wdbRunningScript";
          _0x2e0287.innerHTML = diceScript;
          document.head.appendChild(_0x2e0287);
        } else if (mode === "advanced") {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x1d05fb => _0x1d05fb.disabled = false);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x3b5d87 => _0x3b5d87.disabled = false);
    document.getElementById("wdbStopOnWinButton").disabled = false;
  }
}
async function resume(_0x3a2730) {
  if (!run) {
    document.getElementById("wdbMenuCoin").disabled = true;
    document.getElementById("wdbMenuMode").disabled = true;
    document.getElementById("wdbStartButton").disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x313546 => _0x313546.disabled = true);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x1f3755 => _0x1f3755.disabled = true);
    if (!_0x3a2730) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x39daa2 => setTimeout(_0x39daa2, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === "plinko") {
        const _0x3b7c14 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x163201 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x3b7c14 + " to win";
        log(_0x163201);
      } else {
        const _0x49cf22 = game === "dice" ? bethigh ? "high" : 'low' : "high";
        const _0x5edea1 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x49cf22;
        log(_0x5edea1);
      }
    }
    if (run) {
...
function invest(_0xeec995) {
  return _0xeec995;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x33e62c) {
  return new Promise(_0x3c751b => setTimeout(_0x3c751b, _0x33e62c * 0x3e8));
}
function initLua() {
  ...
  const _0x5333bd = location.hostname.replace("www.", '');
  let _0x173676 = _0x5333bd.indexOf('.');
  casino = _0x5333bd.slice(0x0, _0x173676);
...
function randomString(_0x190fa4, _0x35f91d) {
  const _0x5d952d = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  const _0x1e8ed3 = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
  let _0x1281ed = '';
  let _0x3632b6 = '';
  if (!_0x35f91d) {
    _0x1281ed = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x5d952d;
  }
  if (_0x35f91d === "alphabet") {
    _0x1281ed = "abcdefghijklmnopqrstuvwxyz" + _0x5d952d;
  }
  if (_0x35f91d === "numeric") {
    _0x1281ed = '0123456789';
  }
  if (_0x35f91d === "hex") {
    _0x1281ed = '0123456789' + _0x1e8ed3;
  }
  for (let _0x4f85d2 = 0x0; _0x4f85d2 < _0x190fa4; _0x4f85d2++) {
    _0x3632b6 += _0x1281ed.charAt(Math.floor(Math.random() * _0x1281ed.length));
  }
  return _0x3632b6;
}
function setCookie(_0x6c4969, _0x5069e4, _0x260c6c) {
  const _0x213849 = new Date();
  _0x213849.setTime(_0x213849.getTime() + _0x260c6c * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0x45d374 = "expires=" + _0x213849.toUTCString();
  document.cookie = _0x6c4969 + '=' + _0x5069e4 + ';' + _0x45d374 + ";path=/";
}
function getCookie(_0x4e0ee5) {
  _0x4e0ee5 = _0x4e0ee5 + '=';
  let _0x100376 = decodeURIComponent(document.cookie);
  let _0x42582d = _0x100376.split(';');
  for (let _0x8312b7 = 0x0; _0x8312b7 < _0x42582d.length; _0x8312b7++) {
    let _0x31757f = _0x42582d[_0x8312b7];
    while (_0x31757f.charAt(0x0) === " ") {
      _0x31757f = _0x31757f.substring(0x1);
    }
    if (_0x31757f.indexOf(_0x4e0ee5) === 0x0) {
      return _0x31757f.substring(_0x4e0ee5.length, _0x31757f.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x22537e = null;
  if (mode === "lua") {
    _0x22537e = luaEditor.getValue();
  } else {
    _0x22537e = jsEditor.getValue();
  }
  let _0x2d2b79 = document.createElement('a');
  _0x2d2b79.href = window.URL.createObjectURL(new Blob([_0x22537e], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x2d2b79.download = mode === "lua" ? "DiceScript" + Date.now() + '.lua' : 'DiceScript' + Date.now() + ".js";
  _0x2d2b79.click();
}
function getErrMsg(_0x125804) {
  const _0x1397ed = _0x125804.response && _0x125804.response.data && _0x125804.response.data.message || _0x125804.message || _0x125804.toString();
  return _0x1397ed;
}
...
async function getListCoin() {
  const _0x1ad99c = JSON.stringify({
    'operationName': 'UserBalances',
    'query': "query UserBalances {\n      user {\n        balances {\n          available {\n            amount\n            currency\n          }\n        }\n      }\n    }"
  });
  const {
    data: _0x92bf0b
  } = await axios.post(CASINO_API, _0x1ad99c);
  const _0x48b2f5 = _0x92bf0b.data.user.balances;
  for (let _0xd92245 = 0x0; _0xd92245 < _0x48b2f5.length; _0xd92245++) {
    coins.push(String(_0x48b2f5[_0xd92245].available.currency).toUpperCase());
  }
  coins = coins.sort();
  coin = coins[0x0];
  drawSelectCoin();
...
async function checkbalance() {
  try {
    const _0x497ca3 = JSON.stringify({
      'operationName': "UserBalances",
      'query': "query UserBalances {\n        user {\n          balances {\n            available {\n              amount\n              currency\n            }\n          }\n        }\n      }"
    });
    const {
      data: _0x5504dc
    } = await axios.post(CASINO_API, _0x497ca3);
    const _0x333a41 = _0x5504dc.data.user.balances;
    const _0xc49fad = _0x333a41.find(_0x1fc5e8 => _0x1fc5e8.available.currency === String(coin).toLowerCase());
    balance = Number(_0xc49fad.available.amount);
    ...
    stop();
    return log(getErrMsg(_0xe002b7));
  }
}
async function resetseed() {
  try {
    const _0x3bcb3a = JSON.stringify({
    ...
    return axios.post(CASINO_API, _0x3bcb3a);
  } catch (_0x21ad87) {
    stop();
    return log(getErrMsg(_0x21ad87));
  }
}
async function sendBet() {
  try {
    ...
    const _0x4585b9 = JSON.stringify({
    ...
    const {
      data: _0x4dd6f4
    } = await axios.post(CASINO_API, _0x4585b9);
    if (_0x4dd6f4.errors) {
      if (_0x4dd6f4.errors[0x0].message === "an unknown error 294779 has happened.") {
        if (run) {
          return resetseed().then(sendBet);
        }
      } else {
        if (_0x4dd6f4.errors[0x0].message === "Please choose a new seed pair") {
          if (run) {
            return resetseed().then(sendBet);
          }
        } else {
          if (_0x4dd6f4.errors[0x0].message === "Please slow down") {
            if (run) {
              return setTimeout(sendBet, 0x3e8);
            }
          } else {
            stop();
            return log(_0x4dd6f4.errors[0x0].message);
          }
        }
      }
    } else {
      return handleResult(_0x4dd6f4.data.diceRoll);
    }
  } catch (_0x28c96c) {
    if (_0x28c96c.response) {
      const _0x10d602 = _0x28c96c.response.status;
      if (_0x10d602 === 0x190) {
        stop();
        return log(_0x28c96c.response.data.errors[0x0].message);
      }
      if (run) {
        return sendBet();
      }
    } else {
      if (_0x28c96c.request) {
        if (run) {
          return sendBet();
        }
      } else {
        stop();
        return log(getErrMsg(_0x28c96c));
      }
    }
  }
}
async function handleResult(_0x46c28d) {
  try {
    currentprofit = _0x46c28d.payout - _0x46c28d.amount;
    lastBet.roll = _0x46c28d.state.result;
    result = _0x46c28d.state.result;
    lastBet.nonce = _0x46c28d.nonce;
    lastBet.id = String(_0x46c28d.id);
    return handleStats();
  } catch (_0x319b36) {
    stop();
    return log(getErrMsg(_0x319b36));
  }
}