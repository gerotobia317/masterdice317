...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x1de4e6 => _0x1de4e6.style.color = "#fff");
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x1d51c3 => _0x1d51c3.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x461c64) {
  if (_0x461c64.innerText === '▼') {
...
function toggleHideControlBot(_0x4b3478) {
  if (_0x4b3478.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x5a0871 = '';
  coins.map(_0x35511a => {
    _0x5a0871 += "<option value=\"" + _0x35511a + "\">" + _0x35511a + '</option>';
  });
  document.getElementById('wdbMenuCoin').innerHTML = _0x5a0871;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x4bea89 = document.createElement("div");
  _0x4bea89.id = "wdbWrap";
  _0x4bea89.innerHTML = wdbUI;
  document.body.prepend(_0x4bea89);
  const _0x4cb2cc = document.getElementById("wdb");
  let _0x4cbc63 = 0x0;
  let _0x47d40f = 0x0;
  let _0x8cd3d0 = 0x0;
  let _0x7cf335 = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x1abf7a;
  } else {
    _0x4cb2cc.onmousedown = _0x1abf7a;
  }
  if (document.getElementById("wdbFooter")) {
    document.getElementById("wdbFooter").onmousedown = _0x1abf7a;
  } else {
    _0x4cb2cc.onmousedown = _0x1abf7a;
  }
  function _0x1abf7a(_0x5bd8e7) {
    _0x5bd8e7 = _0x5bd8e7 || window.event;
    _0x5bd8e7.preventDefault();
    _0x8cd3d0 = _0x5bd8e7.clientX;
    _0x7cf335 = _0x5bd8e7.clientY;
    document.onmouseup = _0x50dd8c;
    document.onmousemove = _0xedb432;
  }
  function _0xedb432(_0x345c45) {
    _0x345c45 = _0x345c45 || window.event;
    _0x345c45.preventDefault();
    _0x4cbc63 = _0x8cd3d0 - _0x345c45.clientX;
    _0x47d40f = _0x7cf335 - _0x345c45.clientY;
    _0x8cd3d0 = _0x345c45.clientX;
    _0x7cf335 = _0x345c45.clientY;
    _0x4cb2cc.style.top = _0x4cb2cc.offsetTop - _0x47d40f + 'px';
    _0x4cb2cc.style.left = _0x4cb2cc.offsetLeft - _0x4cbc63 + 'px';
  }
  function _0x50dd8c() {
  ...
  wdbTimer.addEventListener("secondsUpdated", () => {
    const _0x65369f = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById("wdbTime").innerText = _0x65369f;
  });
  ...
  luaFileSelector.addEventListener("change", async _0x2816f3 => {
    const _0x5f396e = await new Response(_0x2816f3.target.files[0x0]).text();
    if (!_0x5f396e) {
      return;
    }
    luaEditor.setValue(_0x5f396e);
  });
  ...
  jsFileSelector.addEventListener("change", async _0x129760 => {
    const _0x2fc3ef = await new Response(_0x129760.target.files[0x0]).text();
    if (!_0x2fc3ef) {
      return;
    }
    jsEditor.setValue(_0x2fc3ef);
  });
  drawChart();
}
async function wdbLoader(_0x29f6bf, _0x54e247) {
  await _0x29f6bf("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
  await _0x54e247("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
  await _0x54e247("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x29f6bf("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x29f6bf('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js');
  await _0x29f6bf("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x29f6bf(WDB_API + '/' + WDB_MODE + "/lib/chart.js");
  await _0x29f6bf(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
  await _0x29f6bf(WDB_API + '/' + WDB_MODE + '/lib/fengari.js');
  await _0x29f6bf(WDB_API + '/' + WDB_MODE + "/lib/ms.js");
  await beforeWork(_0x29f6bf);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log("Connected");
...
function selectFunction(_0x8a2d90) {
  if (_0x8a2d90 === "resetall") {
    resetall();
  }
  if (_0x8a2d90 === 'resetstats') {
    resetstats();
  }
  if (_0x8a2d90 === "resetchart") {
    toggleChart("reset");
  }
  if (_0x8a2d90 === "resethistory") {
    toggleHistory("clear");
  }
  if (_0x8a2d90 === 'resetlog') {
    toggleLog("clear");
  }
  if (_0x8a2d90 === "resetseed") {
    resetseed();
  }
  if (_0x8a2d90 === "stopchart") {
    toggleChart('stop');
  }
  if (_0x8a2d90 === "startchart") {
    toggleChart("start");
  }
  if (_0x8a2d90 === "stophistory") {
    toggleHistory('stop');
  }
  if (_0x8a2d90 === "starthistory") {
    toggleHistory("start");
  }
  if (_0x8a2d90 === "stoplog") {
    toggleLog('stop');
  }
  if (_0x8a2d90 === "startlog") {
    toggleLog("start");
  }
  if (_0x8a2d90 === "hidestats") {
    toggleStats("hide");
  }
  if (_0x8a2d90 === "showstats") {
    toggleStats("show");
  }
  if (_0x8a2d90 === "hidechart") {
    toggleChart("hide");
  }
  if (_0x8a2d90 === 'showchart') {
    toggleChart("show");
  }
  if (_0x8a2d90 === "hidehistory") {
    toggleHistory("hide");
  }
  if (_0x8a2d90 === 'showhistory') {
    toggleHistory("show");
  }
}
function toggleMode(_0x206f6a) {
  mode = _0x206f6a;
  if (_0x206f6a === "lua") {
...
function toggleHistory(_0x521c04) {
  if (_0x521c04 === "hide") {
...
function toggleLog(_0x656d74) {
  if (_0x656d74 === "stop") {
    stopLog = true;
  } else {
    if (_0x656d74 === "start") {
      stopLog = false;
    } else if (_0x656d74 === "clear") {
...
async function handleStats() {
  ...
  const _0x5b106e = await updateStats();
  const _0xd921f1 = await updateChart();
  const _0x2a32ab = await updateHistory();
  Promise.all([_0x5b106e, _0xd921f1, _0x2a32ab]).then(async _0x5ef218 => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x5e7de0 = profit === 0x0 ? darkMode ? "white" : "black" : profit < 0x0 ? "red" : "green";
  const _0x1549fe = currentstreak === 0x0 ? darkMode ? "white" : "black" : currentstreak < 0x0 ? "red" : "green";
  const _0x2a034c = maxwinstreak > 0x0 ? "green" : "black";
  document.getElementById('wdbHighWinStreak').style.color = _0x2a034c;
  const _0x463645 = maxlosestreak > 0x0 ? "red" : "black";
  document.getElementById("wdbHighLoseStreak").style.color = _0x463645;
  ...
  document.getElementById("wdbProfit").style.color = _0x5e7de0;
  ...
  document.getElementById("wdbCurrentStreak").style.color = _0x1549fe;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x5e7de0;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x275c68 = game === "dice" ? bethigh ? '>' : '<' : '>';
    const _0x318787 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x2498d3 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x202890 = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x318787 + "</td>\n      <td>" + (game === "plinko" ? _0x2498d3 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x2498d3 : _0x275c68 + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0x2c5ce5 = document.createElement('tr');
    if (win) {
      _0x2c5ce5.style.backgroundColor = "#91f190";
    } else {
      _0x2c5ce5.style.backgroundColor = "#ffc0cb";
    }
    _0x2c5ce5.innerHTML = _0x202890;
    document.getElementById("wdbHistory").insertBefore(_0x2c5ce5, document.getElementById("wdbHistory").children[0x0]);
    const _0x1ffc6f = document.querySelector("#wdbHistory").rows;
    if (_0x1ffc6f.length > maxRows) {
      document.querySelector('#wdbHistory').lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x5a9aa8) {
  const _0x174763 = document.getElementById("wdbLog");
  const _0x5ebb08 = document.createElement('li');
  _0x5ebb08.innerText = '' + _0x5a9aa8;
  document.getElementById("wdbLog").insertBefore(_0x5ebb08, _0x174763.children[0x0]);
  const _0x4e52eb = _0x174763.getElementsByTagName('li');
  if (_0x4e52eb.length > maxRows) {
    document.getElementById("wdbLog").removeChild(_0x174763.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x25591c => _0x25591c.disabled = true);
      document.querySelectorAll("#wdbOpenScript").forEach(_0x54329e => _0x54329e.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === "lua") {
        ...
        if (mode === 'js') {
          ...
          let _0x142dbb = document.createElement("script");
          _0x142dbb.id = "wdbRunningScript";
          _0x142dbb.innerHTML = diceScript;
          document.head.appendChild(_0x142dbb);
        } else if (mode === 'advanced') {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x5e9a5f => _0x5e9a5f.disabled = false);
    document.querySelectorAll('#wdbOpenScript').forEach(_0x2dfc62 => _0x2dfc62.disabled = false);
    document.getElementById("wdbStopOnWinButton").disabled = false;
  }
}
async function resume(_0x1bdf04) {
  if (!run) {
    document.getElementById("wdbMenuCoin").disabled = true;
    document.getElementById('wdbMenuMode').disabled = true;
    document.getElementById("wdbStartButton").disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x24fd95 => _0x24fd95.disabled = true);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x17101e => _0x17101e.disabled = true);
    if (!_0x1bdf04) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x3e23cc => setTimeout(_0x3e23cc, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === "plinko") {
        const _0x4f526e = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x4d995d = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x4f526e + " to win";
        log(_0x4d995d);
      } else {
        const _0x59554b = game === "dice" ? bethigh ? 'high' : "low" : 'high';
        const _0x11d677 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x59554b;
        log(_0x11d677);
      }
    }
    if (run) {
...
function invest(_0x54b53b) {
  return _0x54b53b;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x31d08c) {
  return new Promise(_0x32ef9d => setTimeout(_0x32ef9d, _0x31d08c * 0x3e8));
}
function initLua() {
  ...
  const _0x5367da = location.hostname.replace("www.", '');
  let _0x4bee77 = _0x5367da.indexOf('.');
  casino = _0x5367da.slice(0x0, _0x4bee77);
...
function randomString(_0x2e8c13, _0x2e16b7) {
  const _0x1df87e = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  const _0x1fb9fb = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
  let _0x35032b = '';
  let _0x5d7c84 = '';
  if (!_0x2e16b7) {
    _0x35032b = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x1df87e;
  }
  if (_0x2e16b7 === "alphabet") {
    _0x35032b = "abcdefghijklmnopqrstuvwxyz" + _0x1df87e;
  }
  if (_0x2e16b7 === 'numeric') {
    _0x35032b = "0123456789";
  }
  if (_0x2e16b7 === 'hex') {
    _0x35032b = "0123456789" + _0x1fb9fb;
  }
  for (let _0x15b619 = 0x0; _0x15b619 < _0x2e8c13; _0x15b619++) {
    _0x5d7c84 += _0x35032b.charAt(Math.floor(Math.random() * _0x35032b.length));
  }
  return _0x5d7c84;
}
function setCookie(_0x1d7a36, _0x15f714, _0x2c23e4) {
  const _0xe8a550 = new Date();
  _0xe8a550.setTime(_0xe8a550.getTime() + _0x2c23e4 * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0x202d6e = "expires=" + _0xe8a550.toUTCString();
  document.cookie = _0x1d7a36 + '=' + _0x15f714 + ';' + _0x202d6e + ";path=/";
}
function getCookie(_0x29631f) {
  _0x29631f = _0x29631f + '=';
  let _0x2b8ae2 = decodeURIComponent(document.cookie);
  let _0x4164bb = _0x2b8ae2.split(';');
  for (let _0x4cf12d = 0x0; _0x4cf12d < _0x4164bb.length; _0x4cf12d++) {
    let _0x1676f1 = _0x4164bb[_0x4cf12d];
    while (_0x1676f1.charAt(0x0) === " ") {
      _0x1676f1 = _0x1676f1.substring(0x1);
    }
    if (_0x1676f1.indexOf(_0x29631f) === 0x0) {
      return _0x1676f1.substring(_0x29631f.length, _0x1676f1.length);
    }
  }
  return '';
}
function saveScript() {
  let _0xf5d3c7 = null;
  if (mode === "lua") {
    _0xf5d3c7 = luaEditor.getValue();
  } else {
    _0xf5d3c7 = jsEditor.getValue();
  }
  let _0x42ae88 = document.createElement('a');
  _0x42ae88.href = window.URL.createObjectURL(new Blob([_0xf5d3c7], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x42ae88.download = mode === "lua" ? "DiceScript" + Date.now() + '.lua' : "DiceScript" + Date.now() + ".js";
  _0x42ae88.click();
}
function getErrMsg(_0x27aeb4) {
  const _0x5e72f0 = _0x27aeb4.response && _0x27aeb4.response.data && _0x27aeb4.response.data.message || _0x27aeb4.message || _0x27aeb4.toString();
  return _0x5e72f0;
}
game = "limbo";
...
async function getListCoin() {
  ...
  const _0x321124 = _0x4e65be.balances;
  for (let _0x19b05b = 0x0; _0x19b05b < _0x321124.length; _0x19b05b++) {
    coins.push(String(_0x321124[_0x19b05b].currency).toUpperCase());
  }
  coins = coins.sort();
  coin = coins[0x0];
  drawSelectCoin();
...
async function checkbalance() {
  try {
    ...
    const _0x1a8179 = _0xcb4a54.balances.find(_0x34a03b => _0x34a03b.currency == String(coin).toLowerCase());
    balance = Number(_0x1a8179.amount);
    ...
    const _0x25a078 = await getMinBet();
    for (const _0x4411c7 in _0x25a078.data.settings) {
      if (String(_0x4411c7).toUpperCase() === coin) {
        minbet = _0x25a078.data.settings[_0x4411c7].casino.amount_minimum;
        return maxbet = _0x25a078.data.settings[_0x4411c7].casino.amount_maximum;
      }
    }
    ...
    stop();
    return log(getErrMsg(_0x60a19));
  }
}
async function resetseed() {
  try {
    const _0x2b33ee = JSON.stringify({
      'client_seed': randomString(0x14, "numeric")
    });
    await axios.post("/api/v1/user/seed/refresh", _0x2b33ee);
    return axios.get("/api/v1/game/seed/refresh");
  } catch (_0x4b15c6) {
    stop();
    return log(getErrMsg(_0x4b15c6));
  }
}
async function sendBet() {
  try {
    ...
    const _0x454d08 = JSON.stringify({
    ...
    const {
      data: _0x1d41b3
    } = await axios.post("/api/v2/limbo/manual/play", _0x454d08);
    if (_0x1d41b3.error) {
      if (_0x1d41b3.error === "You can play only one bet at a time.") {
        if (run) {
          return sendBet();
        }
      } else {
        stop();
        return log(_0x1d41b3.error);
      }
    } else {
      return handleResult(_0x1d41b3);
    }
  } catch (_0x2e27d3) {
    if (_0x2e27d3.response) {
      const _0x3e2ff3 = _0x2e27d3.response.status;
      if (!_0x3e2ff3 || _0x3e2ff3 === 0x1ad || _0x3e2ff3 >= 0x1f4) {
        if (run) {
          return sendBet();
        }
      }
      if (_0x3e2ff3 >= 0x190 && _0x3e2ff3 < 0x1f4) {
        stop();
        const _0x33cf22 = _0x2e27d3.response.data;
        for (const _0x2b57d3 in _0x33cf22) {
          if (_0x2b57d3 === "error") {
            log(_0x33cf22[_0x2b57d3].message);
          } else {
            log(_0x2b57d3 + ": " + _0x33cf22[_0x2b57d3]);
          }
        }
      }
    } else {
      if (_0x2e27d3.request) {
        if (run) {
          return sendBet();
        }
      } else {
        stop();
        return log(getErrMsg(_0x2e27d3));
      }
    }
  }
}
async function handleResult(_0xa28787) {
  try {
    currentprofit = Number(_0xa28787.bet.profit);
    lastBet.roll = 0x63 - Number((0x63 / Number(_0xa28787.bet.result_value)).toFixed(0x2));
    result = Number(_0xa28787.bet.result_value);
    lastBet.nonce = _0xa28787.bet.nonce;
    lastBet.id = String(_0xa28787.bet.hash);
    return handleStats();
  } catch (_0x462ec8) {
    stop();
    return log(getErrMsg(_0x462ec8));
  }
}