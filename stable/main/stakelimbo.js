...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x12fbbf => _0x12fbbf.style.color = "#fff");
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x2ab0a6 => _0x2ab0a6.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x28b4e3) {
  if (_0x28b4e3.innerText === '▼') {
...
function toggleHideControlBot(_0x2eedcb) {
  if (_0x2eedcb.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x4e66ff = '';
  coins.map(_0x3c200a => {
    _0x4e66ff += "<option value=\"" + _0x3c200a + "\">" + _0x3c200a + "</option>";
  });
  document.getElementById("wdbMenuCoin").innerHTML = _0x4e66ff;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x19a804 = document.createElement('div');
  _0x19a804.id = 'wdbWrap';
  _0x19a804.innerHTML = wdbUI;
  document.body.prepend(_0x19a804);
  const _0x3e278f = document.getElementById('wdb');
  let _0x496670 = 0x0;
  let _0x382c29 = 0x0;
  let _0x480d90 = 0x0;
  let _0x1378a7 = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x448bd9;
  } else {
    _0x3e278f.onmousedown = _0x448bd9;
  }
  if (document.getElementById('wdbFooter')) {
    document.getElementById('wdbFooter').onmousedown = _0x448bd9;
  } else {
    _0x3e278f.onmousedown = _0x448bd9;
  }
  function _0x448bd9(_0x433413) {
    _0x433413 = _0x433413 || window.event;
    _0x433413.preventDefault();
    _0x480d90 = _0x433413.clientX;
    _0x1378a7 = _0x433413.clientY;
    document.onmouseup = _0x1c12f2;
    document.onmousemove = _0x2076e3;
  }
  function _0x2076e3(_0x528d7a) {
    _0x528d7a = _0x528d7a || window.event;
    _0x528d7a.preventDefault();
    _0x496670 = _0x480d90 - _0x528d7a.clientX;
    _0x382c29 = _0x1378a7 - _0x528d7a.clientY;
    _0x480d90 = _0x528d7a.clientX;
    _0x1378a7 = _0x528d7a.clientY;
    _0x3e278f.style.top = _0x3e278f.offsetTop - _0x382c29 + 'px';
    _0x3e278f.style.left = _0x3e278f.offsetLeft - _0x496670 + 'px';
  }
  function _0x1c12f2() {
  ...
  wdbTimer.addEventListener('secondsUpdated', () => {
    const _0x2144da = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById("wdbTime").innerText = _0x2144da;
  });
  ...
  luaFileSelector.addEventListener("change", async _0x2d0157 => {
    const _0x68f4bd = await new Response(_0x2d0157.target.files[0x0]).text();
    if (!_0x68f4bd) {
      return;
    }
    luaEditor.setValue(_0x68f4bd);
  });
  ...
  jsFileSelector.addEventListener('change', async _0x235566 => {
    const _0x398884 = await new Response(_0x235566.target.files[0x0]).text();
    if (!_0x398884) {
      return;
    }
    jsEditor.setValue(_0x398884);
  });
  drawChart();
}
async function wdbLoader(_0x413202, _0x333887) {
  await _0x413202("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
  await _0x333887('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css');
  await _0x333887("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x413202('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js');
  await _0x413202("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js");
  await _0x413202("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x413202(WDB_API + '/' + WDB_MODE + '/lib/chart.js');
  await _0x413202(WDB_API + '/' + WDB_MODE + '/lib/easytimer.js');
  await _0x413202(WDB_API + '/' + WDB_MODE + '/lib/fengari.js');
  await _0x413202(WDB_API + '/' + WDB_MODE + '/lib/ms.js');
  await beforeWork(_0x413202);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log('Connected');
...
function selectFunction(_0x2f34bd) {
  if (_0x2f34bd === "resetall") {
    resetall();
  }
  if (_0x2f34bd === 'resetstats') {
    resetstats();
  }
  if (_0x2f34bd === "resetchart") {
    toggleChart("reset");
  }
  if (_0x2f34bd === "resethistory") {
    toggleHistory("clear");
  }
  if (_0x2f34bd === 'resetlog') {
    toggleLog('clear');
  }
  if (_0x2f34bd === "resetseed") {
    resetseed();
  }
  if (_0x2f34bd === "stopchart") {
    toggleChart("stop");
  }
  if (_0x2f34bd === "startchart") {
    toggleChart("start");
  }
  if (_0x2f34bd === "stophistory") {
    toggleHistory("stop");
  }
  if (_0x2f34bd === 'starthistory') {
    toggleHistory('start');
  }
  if (_0x2f34bd === "stoplog") {
    toggleLog("stop");
  }
  if (_0x2f34bd === "startlog") {
    toggleLog("start");
  }
  if (_0x2f34bd === "hidestats") {
    toggleStats("hide");
  }
  if (_0x2f34bd === "showstats") {
    toggleStats("show");
  }
  if (_0x2f34bd === "hidechart") {
    toggleChart("hide");
  }
  if (_0x2f34bd === 'showchart') {
    toggleChart("show");
  }
  if (_0x2f34bd === "hidehistory") {
    toggleHistory("hide");
  }
  if (_0x2f34bd === "showhistory") {
    toggleHistory("show");
  }
}
function toggleMode(_0x2248fe) {
  mode = _0x2248fe;
  if (_0x2248fe === "lua") {
...
function toggleHistory(_0x435801) {
  if (_0x435801 === "hide") {
...
function toggleLog(_0x240773) {
  if (_0x240773 === 'stop') {
    stopLog = true;
  } else {
    if (_0x240773 === "start") {
      stopLog = false;
    } else if (_0x240773 === "clear") {
...
async function handleStats() {
  ...
  const _0x3e9436 = await updateStats();
  const _0x55ad31 = await updateChart();
  const _0x5e296c = await updateHistory();
  Promise.all([_0x3e9436, _0x55ad31, _0x5e296c]).then(async _0x441118 => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x3e4bf2 = profit === 0x0 ? darkMode ? "white" : "black" : profit < 0x0 ? 'red' : "green";
  const _0x2e1cba = currentstreak === 0x0 ? darkMode ? "white" : "black" : currentstreak < 0x0 ? 'red' : "green";
  const _0x343106 = maxwinstreak > 0x0 ? 'green' : "black";
  document.getElementById("wdbHighWinStreak").style.color = _0x343106;
  const _0xb0e429 = maxlosestreak > 0x0 ? "red" : "black";
  document.getElementById("wdbHighLoseStreak").style.color = _0xb0e429;
  ...
  document.getElementById("wdbProfit").style.color = _0x3e4bf2;
  ...
  document.getElementById("wdbCurrentStreak").style.color = _0x2e1cba;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x3e4bf2;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x4f719c = game === "dice" ? bethigh ? '>' : '<' : '>';
    const _0x4d1fe0 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x2dacd6 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x48cc8c = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x4d1fe0 + "</td>\n      <td>" + (game === "plinko" ? _0x2dacd6 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x2dacd6 : _0x4f719c + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0x526ee8 = document.createElement('tr');
    if (win) {
      _0x526ee8.style.backgroundColor = "#91f190";
    } else {
      _0x526ee8.style.backgroundColor = "#ffc0cb";
    }
    _0x526ee8.innerHTML = _0x48cc8c;
    document.getElementById("wdbHistory").insertBefore(_0x526ee8, document.getElementById("wdbHistory").children[0x0]);
    const _0x5ae2cd = document.querySelector("#wdbHistory").rows;
    if (_0x5ae2cd.length > maxRows) {
      document.querySelector("#wdbHistory").lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x5ea42b) {
  const _0x37ad72 = document.getElementById("wdbLog");
  const _0x14a8dd = document.createElement('li');
  _0x14a8dd.innerText = '' + _0x5ea42b;
  document.getElementById("wdbLog").insertBefore(_0x14a8dd, _0x37ad72.children[0x0]);
  const _0x2e270a = _0x37ad72.getElementsByTagName('li');
  if (_0x2e270a.length > maxRows) {
    document.getElementById("wdbLog").removeChild(_0x37ad72.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x5877d4 => _0x5877d4.disabled = true);
      document.querySelectorAll('#wdbOpenScript').forEach(_0x4b31fd => _0x4b31fd.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === "lua") {
        ...
        if (mode === 'js') {
          ...
          let _0x34e4eb = document.createElement("script");
          _0x34e4eb.id = "wdbRunningScript";
          _0x34e4eb.innerHTML = diceScript;
          document.head.appendChild(_0x34e4eb);
        } else if (mode === 'advanced') {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x55dfaa => _0x55dfaa.disabled = false);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x30e546 => _0x30e546.disabled = false);
    document.getElementById("wdbStopOnWinButton").disabled = false;
  }
}
async function resume(_0x1f80d0) {
  if (!run) {
    document.getElementById('wdbMenuCoin').disabled = true;
    document.getElementById("wdbMenuMode").disabled = true;
    document.getElementById('wdbStartButton').disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x486937 => _0x486937.disabled = true);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x3b87d3 => _0x3b87d3.disabled = true);
    if (!_0x1f80d0) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x130646 => setTimeout(_0x130646, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === "plinko") {
        const _0x1b5ea9 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x1388d6 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x1b5ea9 + " to win";
        log(_0x1388d6);
      } else {
        const _0x55ae5d = game === "dice" ? bethigh ? "high" : "low" : 'high';
        const _0x23e472 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x55ae5d;
        log(_0x23e472);
      }
    }
    if (run) {
...
function invest(_0x4839c9) {
  return _0x4839c9;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x77c2e5) {
  return new Promise(_0x231446 => setTimeout(_0x231446, _0x77c2e5 * 0x3e8));
}
function initLua() {
  ...
  const _0x4f8948 = location.hostname.replace("www.", '');
  let _0x153817 = _0x4f8948.indexOf('.');
  casino = _0x4f8948.slice(0x0, _0x153817);
...
function randomString(_0x5ee2c0, _0x303373) {
  const _0x3035f9 = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  const _0x2b3524 = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
  let _0x517955 = '';
  let _0x4f3484 = '';
  if (!_0x303373) {
    _0x517955 = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x3035f9;
  }
  if (_0x303373 === "alphabet") {
    _0x517955 = "abcdefghijklmnopqrstuvwxyz" + _0x3035f9;
  }
  if (_0x303373 === "numeric") {
    _0x517955 = "0123456789";
  }
  if (_0x303373 === "hex") {
    _0x517955 = "0123456789" + _0x2b3524;
  }
  for (let _0x438bde = 0x0; _0x438bde < _0x5ee2c0; _0x438bde++) {
    _0x4f3484 += _0x517955.charAt(Math.floor(Math.random() * _0x517955.length));
  }
  return _0x4f3484;
}
function setCookie(_0x4acdaa, _0x6c581c, _0x30b666) {
  const _0x45ebe8 = new Date();
  _0x45ebe8.setTime(_0x45ebe8.getTime() + _0x30b666 * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0x6a35b4 = "expires=" + _0x45ebe8.toUTCString();
  document.cookie = _0x4acdaa + '=' + _0x6c581c + ';' + _0x6a35b4 + ";path=/";
}
function getCookie(_0x3a77d4) {
  _0x3a77d4 = _0x3a77d4 + '=';
  let _0x317ac7 = decodeURIComponent(document.cookie);
  let _0x461a80 = _0x317ac7.split(';');
  for (let _0x56491b = 0x0; _0x56491b < _0x461a80.length; _0x56491b++) {
    let _0x537493 = _0x461a80[_0x56491b];
    while (_0x537493.charAt(0x0) === " ") {
      _0x537493 = _0x537493.substring(0x1);
    }
    if (_0x537493.indexOf(_0x3a77d4) === 0x0) {
      return _0x537493.substring(_0x3a77d4.length, _0x537493.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x1ba262 = null;
  if (mode === "lua") {
    _0x1ba262 = luaEditor.getValue();
  } else {
    _0x1ba262 = jsEditor.getValue();
  }
  let _0x65cec = document.createElement('a');
  _0x65cec.href = window.URL.createObjectURL(new Blob([_0x1ba262], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x65cec.download = mode === "lua" ? "DiceScript" + Date.now() + ".lua" : "DiceScript" + Date.now() + '.js';
  _0x65cec.click();
}
function getErrMsg(_0x124f23) {
  const _0x28edd4 = _0x124f23.response && _0x124f23.response.data && _0x124f23.response.data.message || _0x124f23.message || _0x124f23.toString();
  return _0x28edd4;
}
game = "limbo";
...
async function getListCoin() {
  const _0x18e8e2 = JSON.stringify({
    'operationName': "UserBalances",
    'query': "query UserBalances {\n      user {\n        balances {\n          available {\n            amount\n            currency\n          }\n        }\n      }\n    }"
  });
  const {
    data: _0x1b8aaa
  } = await axios.post(CASINO_API, _0x18e8e2);
  const _0x42f6c2 = _0x1b8aaa.data.user.balances;
  for (let _0x2d14f4 = 0x0; _0x2d14f4 < _0x42f6c2.length; _0x2d14f4++) {
    coins.push(String(_0x42f6c2[_0x2d14f4].available.currency).toUpperCase());
  }
  coins = coins.sort();
  coin = coins[0x0];
  drawSelectCoin();
...
async function checkbalance() {
  try {
    const _0x1eb49b = JSON.stringify({
      'operationName': "UserBalances",
      'variables': {},
      'query': "query UserBalances {\n        user {\n          balances {\n            available {\n              amount\n              currency\n            }\n          }\n        }\n      }"
    });
    const {
      data: _0x52fe9d
    } = await axios.post(CASINO_API, _0x1eb49b);
    const _0x536d39 = _0x52fe9d.data.user.balances;
    const _0x2ae49b = _0x536d39.find(_0x51119f => _0x51119f.available.currency === String(coin).toLowerCase());
    balance = Number(_0x2ae49b.available.amount);
    ...
    stop();
    return log(getErrMsg(_0x322cc5));
  }
}
async function resetseed() {
  try {
    const _0x4aba51 = JSON.stringify({
    ...
    return axios.post(CASINO_API, _0x4aba51);
  } catch (_0x157423) {
    stop();
    return log(getErrMsg(_0x157423));
  }
}
async function sendBet() {
  try {
    chance = Math.round((chance + Number.EPSILON) * 0x5f5e100) / 0x5f5e100;
    target = Math.round((0x63 / chance + Number.EPSILON) * 0x64) / 0x64;
    const _0xad16da = JSON.stringify({
    ...
    const {
      data: _0x149767
    } = await axios.post(CASINO_API, _0xad16da);
    if (_0x149767.errors) {
      const _0x4db980 = _0x149767.errors[0x0].message;
      if (_0x4db980 === "an unknown error 294779 has happened.") {
        if (run) {
          return sendBet();
        }
      } else {
        if (_0x4db980 === "Please choose a new seed pair") {
          if (run) {
            return resetseed().then(sendBet);
          }
        } else {
          if (_0x4db980 === "Please slow down") {
            if (run) {
              return setTimeout(sendBet, 0x3e8);
            }
          } else {
            stop();
            return log(_0x4db980);
          }
        }
      }
    } else {
      return handleResult(_0x149767.data.limboBet);
    }
  } catch (_0x4d90c2) {
    if (_0x4d90c2.response) {
      const _0x41df88 = _0x4d90c2.response.status;
      if (_0x41df88 === 0x190) {
        stop();
        return log(_0x4d90c2.response.data.errors[0x0].message);
      }
      if (run) {
        return sendBet();
      }
    } else {
      if (_0x4d90c2.request) {
        if (run) {
          return sendBet();
        }
      } else {
        stop();
        return log(getErrMsg(_0x4d90c2));
      }
    }
  }
}
async function handleResult(_0x4fbffa) {
  try {
    currentprofit = _0x4fbffa.payout - _0x4fbffa.amount;
    lastBet.roll = Math.round((0x63 / _0x4fbffa.state.result + Number.EPSILON) * 0x64) / 0x64;
    result = _0x4fbffa.state.result;
    lastBet.nonce = _0x4fbffa.nonce;
    lastBet.id = String(_0x4fbffa.id);
    return handleStats();
  } catch (_0x273bf8) {
    stop();
    return log(getErrMsg(_0x273bf8));
  }
}