...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x10f308 => _0x10f308.style.color = '#fff');
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x5d153f => _0x5d153f.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x45c0fa) {
  if (_0x45c0fa.innerText === '▼') {
...
function toggleHideControlBot(_0x4e7259) {
  if (_0x4e7259.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x1bf2a7 = '';
  coins.map(_0x4bfaa0 => {
    _0x1bf2a7 += "<option value=\"" + _0x4bfaa0 + "\">" + _0x4bfaa0 + '</option>';
  });
  document.getElementById('wdbMenuCoin').innerHTML = _0x1bf2a7;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x29c83d = document.createElement("div");
  _0x29c83d.id = 'wdbWrap';
  _0x29c83d.innerHTML = wdbUI;
  document.body.prepend(_0x29c83d);
  const _0x42a08d = document.getElementById("wdb");
  let _0x1a6b15 = 0x0;
  let _0x2cf5cc = 0x0;
  let _0x253073 = 0x0;
  let _0x18aa8c = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x1cf8b3;
  } else {
    _0x42a08d.onmousedown = _0x1cf8b3;
  }
  if (document.getElementById("wdbFooter")) {
    document.getElementById("wdbFooter").onmousedown = _0x1cf8b3;
  } else {
    _0x42a08d.onmousedown = _0x1cf8b3;
  }
  function _0x1cf8b3(_0x42aee8) {
    _0x42aee8 = _0x42aee8 || window.event;
    _0x42aee8.preventDefault();
    _0x253073 = _0x42aee8.clientX;
    _0x18aa8c = _0x42aee8.clientY;
    document.onmouseup = _0x1e4f59;
    document.onmousemove = _0x1da544;
  }
  function _0x1da544(_0x4836d6) {
    _0x4836d6 = _0x4836d6 || window.event;
    _0x4836d6.preventDefault();
    _0x1a6b15 = _0x253073 - _0x4836d6.clientX;
    _0x2cf5cc = _0x18aa8c - _0x4836d6.clientY;
    _0x253073 = _0x4836d6.clientX;
    _0x18aa8c = _0x4836d6.clientY;
    _0x42a08d.style.top = _0x42a08d.offsetTop - _0x2cf5cc + 'px';
    _0x42a08d.style.left = _0x42a08d.offsetLeft - _0x1a6b15 + 'px';
  }
  function _0x1e4f59() {
  ...
  wdbTimer.addEventListener("secondsUpdated", () => {
    const _0x1f0c3f = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById("wdbTime").innerText = _0x1f0c3f;
  });
  ...
  luaFileSelector.addEventListener("change", async _0x22251b => {
    const _0x18fb76 = await new Response(_0x22251b.target.files[0x0]).text();
    if (!_0x18fb76) {
      return;
    }
    luaEditor.setValue(_0x18fb76);
  });
  ...
  jsFileSelector.addEventListener('change', async _0x5abdf9 => {
    const _0x1012e6 = await new Response(_0x5abdf9.target.files[0x0]).text();
    if (!_0x1012e6) {
      return;
    }
    jsEditor.setValue(_0x1012e6);
  });
  drawChart();
}
async function wdbLoader(_0x175a59, _0x357bca) {
  await _0x175a59('https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js');
  await _0x357bca("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
  await _0x357bca("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x175a59("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x175a59("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js");
  await _0x175a59("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x175a59(WDB_API + '/' + WDB_MODE + "/lib/chart.js");
  await _0x175a59(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
  await _0x175a59(WDB_API + '/' + WDB_MODE + '/lib/fengari.js');
  await _0x175a59(WDB_API + '/' + WDB_MODE + "/lib/ms.js");
  await beforeWork(_0x175a59);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log("Connected");
...
function selectFunction(_0x5a4506) {
  if (_0x5a4506 === "resetall") {
    resetall();
  }
  if (_0x5a4506 === 'resetstats') {
    resetstats();
  }
  if (_0x5a4506 === "resetchart") {
    toggleChart('reset');
  }
  if (_0x5a4506 === "resethistory") {
    toggleHistory("clear");
  }
  if (_0x5a4506 === "resetlog") {
    toggleLog("clear");
  }
  if (_0x5a4506 === "resetseed") {
    resetseed();
  }
  if (_0x5a4506 === "stopchart") {
    toggleChart("stop");
  }
  if (_0x5a4506 === "startchart") {
    toggleChart("start");
  }
  if (_0x5a4506 === "stophistory") {
    toggleHistory("stop");
  }
  if (_0x5a4506 === "starthistory") {
    toggleHistory("start");
  }
  if (_0x5a4506 === 'stoplog') {
    toggleLog("stop");
  }
  if (_0x5a4506 === 'startlog') {
    toggleLog("start");
  }
  if (_0x5a4506 === 'hidestats') {
    toggleStats("hide");
  }
  if (_0x5a4506 === "showstats") {
    toggleStats("show");
  }
  if (_0x5a4506 === "hidechart") {
    toggleChart("hide");
  }
  if (_0x5a4506 === 'showchart') {
    toggleChart("show");
  }
  if (_0x5a4506 === "hidehistory") {
    toggleHistory("hide");
  }
  if (_0x5a4506 === "showhistory") {
    toggleHistory("show");
  }
}
function toggleMode(_0x3dd7b5) {
  mode = _0x3dd7b5;
  if (_0x3dd7b5 === "lua") {
...
function toggleHistory(_0x5496c5) {
  if (_0x5496c5 === "hide") {
...
function toggleLog(_0x24b825) {
  if (_0x24b825 === "stop") {
    stopLog = true;
  } else {
    if (_0x24b825 === 'start') {
      stopLog = false;
    } else if (_0x24b825 === "clear") {
...
async function handleStats() {
  ...
  const _0x44bddd = await updateStats();
  const _0x80282f = await updateChart();
  const _0x39d712 = await updateHistory();
  Promise.all([_0x44bddd, _0x80282f, _0x39d712]).then(async _0x320735 => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x3c983e = profit === 0x0 ? darkMode ? "white" : "black" : profit < 0x0 ? 'red' : 'green';
  const _0xc279b7 = currentstreak === 0x0 ? darkMode ? "white" : 'black' : currentstreak < 0x0 ? 'red' : "green";
  const _0x4e022d = maxwinstreak > 0x0 ? 'green' : "black";
  document.getElementById('wdbHighWinStreak').style.color = _0x4e022d;
  const _0x46395e = maxlosestreak > 0x0 ? 'red' : "black";
  document.getElementById('wdbHighLoseStreak').style.color = _0x46395e;
  ...
  document.getElementById("wdbProfit").style.color = _0x3c983e;
  ...
  document.getElementById('wdbCurrentStreak').style.color = _0xc279b7;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x3c983e;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x5cc283 = game === "dice" ? bethigh ? '>' : '<' : '>';
    const _0x462fd6 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x487566 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x9902d6 = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x462fd6 + "</td>\n      <td>" + (game === "plinko" ? _0x487566 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x487566 : _0x5cc283 + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0xb35b4d = document.createElement('tr');
    if (win) {
      _0xb35b4d.style.backgroundColor = "#91f190";
    } else {
      _0xb35b4d.style.backgroundColor = "#ffc0cb";
    }
    _0xb35b4d.innerHTML = _0x9902d6;
    document.getElementById("wdbHistory").insertBefore(_0xb35b4d, document.getElementById("wdbHistory").children[0x0]);
    const _0x5c8427 = document.querySelector("#wdbHistory").rows;
    if (_0x5c8427.length > maxRows) {
      document.querySelector("#wdbHistory").lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x43cdfd) {
  const _0x3cb05f = document.getElementById('wdbLog');
  const _0x4edf3f = document.createElement('li');
  _0x4edf3f.innerText = '' + _0x43cdfd;
  document.getElementById('wdbLog').insertBefore(_0x4edf3f, _0x3cb05f.children[0x0]);
  const _0x29e3a5 = _0x3cb05f.getElementsByTagName('li');
  if (_0x29e3a5.length > maxRows) {
    document.getElementById('wdbLog').removeChild(_0x3cb05f.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x17da6f => _0x17da6f.disabled = true);
      document.querySelectorAll("#wdbOpenScript").forEach(_0xb0e37e => _0xb0e37e.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === "lua") {
        ...
        if (mode === 'js') {
          ...
          let _0x37bf56 = document.createElement("script");
          _0x37bf56.id = "wdbRunningScript";
          _0x37bf56.innerHTML = diceScript;
          document.head.appendChild(_0x37bf56);
        } else if (mode === "advanced") {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x32aef9 => _0x32aef9.disabled = false);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x1e6bd1 => _0x1e6bd1.disabled = false);
    document.getElementById("wdbStopOnWinButton").disabled = false;
  }
}
async function resume(_0x434b90) {
  if (!run) {
    document.getElementById("wdbMenuCoin").disabled = true;
    document.getElementById("wdbMenuMode").disabled = true;
    document.getElementById('wdbStartButton').disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x32b8a7 => _0x32b8a7.disabled = true);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x1f1957 => _0x1f1957.disabled = true);
    if (!_0x434b90) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x43369b => setTimeout(_0x43369b, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === 'plinko') {
        const _0x3ccce0 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x27daf9 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x3ccce0 + " to win";
        log(_0x27daf9);
      } else {
        const _0x140f04 = game === "dice" ? bethigh ? "high" : "low" : "high";
        const _0x2a99f1 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x140f04;
        log(_0x2a99f1);
      }
    }
    if (run) {
...
function invest(_0x5415d3) {
  return _0x5415d3;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x5da2db) {
  return new Promise(_0x5ec093 => setTimeout(_0x5ec093, _0x5da2db * 0x3e8));
}
function initLua() {
  ...
  const _0x28eba3 = location.hostname.replace("www.", '');
  let _0x17d9ed = _0x28eba3.indexOf('.');
  casino = _0x28eba3.slice(0x0, _0x17d9ed);
...
function randomString(_0x1ccece, _0x6369be) {
  const _0x1f53f1 = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  const _0x397d82 = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
  let _0x4a67b1 = '';
  let _0xd873a4 = '';
  if (!_0x6369be) {
    _0x4a67b1 = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x1f53f1;
  }
  if (_0x6369be === 'alphabet') {
    _0x4a67b1 = "abcdefghijklmnopqrstuvwxyz" + _0x1f53f1;
  }
  if (_0x6369be === "numeric") {
    _0x4a67b1 = "0123456789";
  }
  if (_0x6369be === 'hex') {
    _0x4a67b1 = "0123456789" + _0x397d82;
  }
  for (let _0x579eee = 0x0; _0x579eee < _0x1ccece; _0x579eee++) {
    _0xd873a4 += _0x4a67b1.charAt(Math.floor(Math.random() * _0x4a67b1.length));
  }
  return _0xd873a4;
}
function setCookie(_0x5881a2, _0x5945aa, _0x3640e5) {
  const _0x4f2cc0 = new Date();
  _0x4f2cc0.setTime(_0x4f2cc0.getTime() + _0x3640e5 * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0x499327 = "expires=" + _0x4f2cc0.toUTCString();
  document.cookie = _0x5881a2 + '=' + _0x5945aa + ';' + _0x499327 + ';path=/';
}
function getCookie(_0x1afdf8) {
  _0x1afdf8 = _0x1afdf8 + '=';
  let _0x19f810 = decodeURIComponent(document.cookie);
  let _0x1ad860 = _0x19f810.split(';');
  for (let _0x3b45af = 0x0; _0x3b45af < _0x1ad860.length; _0x3b45af++) {
    let _0x2a5c26 = _0x1ad860[_0x3b45af];
    while (_0x2a5c26.charAt(0x0) === " ") {
      _0x2a5c26 = _0x2a5c26.substring(0x1);
    }
    if (_0x2a5c26.indexOf(_0x1afdf8) === 0x0) {
      return _0x2a5c26.substring(_0x1afdf8.length, _0x2a5c26.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x2bac63 = null;
  if (mode === "lua") {
    _0x2bac63 = luaEditor.getValue();
  } else {
    _0x2bac63 = jsEditor.getValue();
  }
  let _0x2cd15d = document.createElement('a');
  _0x2cd15d.href = window.URL.createObjectURL(new Blob([_0x2bac63], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x2cd15d.download = mode === "lua" ? "DiceScript" + Date.now() + '.lua' : "DiceScript" + Date.now() + ".js";
  _0x2cd15d.click();
}
function getErrMsg(_0x222513) {
  const _0x168535 = _0x222513.response && _0x222513.response.data && _0x222513.response.data.message || _0x222513.message || _0x222513.toString();
  return _0x168535;
}
loadingCoin = true;
async function beforeWork(_0x5c7d57) {
  await _0x5c7d57(WDB_API + '/' + WDB_MODE + "/lib/socket3.io.js");
  await _0x5c7d57(WDB_API + '/' + WDB_MODE + "/lib/wtmt.js");
  await _0x5c7d57(WDB_API + '/' + WDB_MODE + "/lib/bc.js");
  await _0x5c7d57(WDB_API + '/' + WDB_MODE + "/lib/timeout.js");
  connectServer();
...
async function resetseed() {
  const _0x3bb813 = randomString(0x18);
  client.emit("dice", {
    'z': o.compressToBase64(JSON.stringify({
      'cs': _0x3bb813,
      'type': 'randomize'
    }))
  }, () => {
...
async function sendBet() {
  ...
  const _0x5b3377 = bcdiv(0x63, chance, 0x3);
  const _0x12789b = {
    'type': "auto",
    'm': true,
    'roll': {
    ...
    'auto': {
      ...
      'li': [0x0, 0x0, 0x0, 0x0, 0x0]
    }
  };
  if (client.connected) {
    if (run) {
      client.emit('dice', {
        'z': o.compressToBase64(JSON.stringify(_0x12789b))
      }, withTimeout(async _0x598930 => {
        const _0x4dc9ac = JSON.parse(o.decompressFromBase64(_0x598930.z));
        if (_0x4dc9ac.error) {
          if (_0x4dc9ac.message === "slow_down") {
            if (run) {
              return sendBet();
            }
          } else {
            stop();
            log(_0x4dc9ac.message);
          }
        } else {
          return handleResult(_0x4dc9ac);
        }
      }, async () => {
        if (run) {
          return sendBet();
    ...
    if (run) {
      return setTimeout(sendBet, 0xbb8);
    }
  }
}
async function handleResult(_0xff0770) {
  try {
    currentprofit = _0xff0770.roll.delta;
    lastBet.roll = _0xff0770.roll.outcome;
    result = _0xff0770.roll.outcome;
    lastBet.nonce = _0xff0770.roll.n;
    lastBet.id = String(_0xff0770.roll._id);
    return handleStats();
  } catch (_0x32f4d5) {
    stop();
    return log(getErrMsg(_0x32f4d5));
  }
}
async function getBalance(_0x1e0849) {
  let _0x57468f = [];
  let _0x8d9230 = 0x0;
  for (const _0x5c6471 in _0x1e0849) {
    if (_0x5c6471.search("balance_") >= 0x0 && _0x5c6471 !== "total_balance_usd") {
      _0x57468f.push({
        'coin': _0x5c6471.slice(0x8),
        'value': Number(_0x1e0849[_0x5c6471]).toFixed(0x8)
      });
    }
  }
  const _0x15dea7 = _0x57468f.filter(_0x41fa5d => _0x41fa5d.coin === String(coin).toLowerCase());
  if (_0x15dea7.length !== 0x0) {
    _0x8d9230 = Number(_0x15dea7[0x0].value);
  } else {
    _0x8d9230 = 0x0;
  }
  delete _0x57468f;
...
function getBuildVersion() {
  ...
  var _0xc5504 = document.getElementsByTagName("script");
  let _0x248d92;
  for (let _0x5bd823 of _0xc5504) {
    const _0x53c326 = _0x5bd823.getAttribute("src");
    if (typeof _0x53c326 !== "string" || !_0x53c326.startsWith("/static/js/main.")) {
      continue;
    }
    _0x248d92 = _0x53c326.substring("/static/js/main.".length, _0x53c326.length - "chunk.js".length - 0x1);
    break;
  }
  return _0x248d92;
}
async function connectServer() {
  client = io("https://back." + window.location.hostname + "/sck?token=" + JSON.parse(localStorage.getItem("cr_token")).key + '&isMobile=0', {
    'transports': ["websocket"]
  });
  client.connect();
  client.on("onInit", async _0x1e48bb => {
    if (loadingCoin) {
      const _0x5b8228 = _0x1e48bb.coins;
      for (const _0x39e873 in _0x5b8228) coins.push(String(_0x5b8228[_0x39e873].short).toUpperCase());
      coins = coins.sort();
      coin = coins[0x0];
      drawSelectCoin();
      checkbalance();
      ...
      balance = await getBalance(_0x1e48bb.balance);
