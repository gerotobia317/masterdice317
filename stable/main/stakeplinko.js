...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x5e21ff => _0x5e21ff.style.color = "#fff");
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x363236 => _0x363236.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x2bff77) {
  if (_0x2bff77.innerText === '▼') {
...
function toggleHideControlBot(_0x512e59) {
  if (_0x512e59.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x294301 = '';
  coins.map(_0x53de65 => {
    _0x294301 += "<option value=\"" + _0x53de65 + "\">" + _0x53de65 + "</option>";
  });
  document.getElementById("wdbMenuCoin").innerHTML = _0x294301;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x3958dc = document.createElement("div");
  _0x3958dc.id = 'wdbWrap';
  _0x3958dc.innerHTML = wdbUI;
  document.body.prepend(_0x3958dc);
  const _0x210238 = document.getElementById("wdb");
  let _0x1d93cc = 0x0;
  let _0x10fb7e = 0x0;
  let _0x2db1c9 = 0x0;
  let _0x3b624b = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x348694;
  } else {
    _0x210238.onmousedown = _0x348694;
  }
  if (document.getElementById("wdbFooter")) {
    document.getElementById("wdbFooter").onmousedown = _0x348694;
  } else {
    _0x210238.onmousedown = _0x348694;
  }
  function _0x348694(_0x4772c5) {
    _0x4772c5 = _0x4772c5 || window.event;
    _0x4772c5.preventDefault();
    _0x2db1c9 = _0x4772c5.clientX;
    _0x3b624b = _0x4772c5.clientY;
    document.onmouseup = _0x15ccdb;
    document.onmousemove = _0x3196fb;
  }
  function _0x3196fb(_0x40d672) {
    _0x40d672 = _0x40d672 || window.event;
    _0x40d672.preventDefault();
    _0x1d93cc = _0x2db1c9 - _0x40d672.clientX;
    _0x10fb7e = _0x3b624b - _0x40d672.clientY;
    _0x2db1c9 = _0x40d672.clientX;
    _0x3b624b = _0x40d672.clientY;
    _0x210238.style.top = _0x210238.offsetTop - _0x10fb7e + 'px';
    _0x210238.style.left = _0x210238.offsetLeft - _0x1d93cc + 'px';
  }
  function _0x15ccdb() {
  ...
  wdbTimer.addEventListener("secondsUpdated", () => {
    const _0x6f5ce = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById("wdbTime").innerText = _0x6f5ce;
  });
  ...
  luaFileSelector.addEventListener("change", async _0x9935fe => {
    const _0x4eefb9 = await new Response(_0x9935fe.target.files[0x0]).text();
    if (!_0x4eefb9) {
      return;
    }
    luaEditor.setValue(_0x4eefb9);
  });
  ...
  jsFileSelector.addEventListener('change', async _0x240dbf => {
    const _0x51927f = await new Response(_0x240dbf.target.files[0x0]).text();
    if (!_0x51927f) {
      return;
    }
    jsEditor.setValue(_0x51927f);
  });
  drawChart();
}
async function wdbLoader(_0x98d423, _0xa6c97) {
  await _0x98d423('https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js');
  await _0xa6c97('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css');
  await _0xa6c97("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x98d423("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x98d423("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js");
  await _0x98d423("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x98d423(WDB_API + '/' + WDB_MODE + "/lib/chart.js");
  await _0x98d423(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
  await _0x98d423(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
  await _0x98d423(WDB_API + '/' + WDB_MODE + "/lib/ms.js");
  await beforeWork(_0x98d423);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log("Connected");
...
function selectFunction(_0x169ed7) {
  if (_0x169ed7 === "resetall") {
    resetall();
  }
  if (_0x169ed7 === 'resetstats') {
    resetstats();
  }
  if (_0x169ed7 === "resetchart") {
    toggleChart("reset");
  }
  if (_0x169ed7 === "resethistory") {
    toggleHistory("clear");
  }
  if (_0x169ed7 === "resetlog") {
    toggleLog('clear');
  }
  if (_0x169ed7 === "resetseed") {
    resetseed();
  }
  if (_0x169ed7 === "stopchart") {
    toggleChart('stop');
  }
  if (_0x169ed7 === "startchart") {
    toggleChart("start");
  }
  if (_0x169ed7 === "stophistory") {
    toggleHistory("stop");
  }
  if (_0x169ed7 === 'starthistory') {
    toggleHistory("start");
  }
  if (_0x169ed7 === "stoplog") {
    toggleLog('stop');
  }
  if (_0x169ed7 === "startlog") {
    toggleLog("start");
  }
  if (_0x169ed7 === "hidestats") {
    toggleStats("hide");
  }
  if (_0x169ed7 === "showstats") {
    toggleStats('show');
  }
  if (_0x169ed7 === "hidechart") {
    toggleChart("hide");
  }
  if (_0x169ed7 === 'showchart') {
    toggleChart('show');
  }
  if (_0x169ed7 === "hidehistory") {
    toggleHistory("hide");
  }
  if (_0x169ed7 === 'showhistory') {
    toggleHistory('show');
  }
}
function toggleMode(_0x31fdc5) {
  mode = _0x31fdc5;
  if (_0x31fdc5 === "lua") {
...
function toggleHistory(_0x5255b3) {
  if (_0x5255b3 === "hide") {
...
function toggleLog(_0x19d893) {
  if (_0x19d893 === "stop") {
    stopLog = true;
  } else {
    if (_0x19d893 === "start") {
      stopLog = false;
    } else if (_0x19d893 === "clear") {
...
async function handleStats() {
  ...
  const _0x34866f = await updateStats();
  const _0x17f049 = await updateChart();
  const _0x2c85e0 = await updateHistory();
  Promise.all([_0x34866f, _0x17f049, _0x2c85e0]).then(async _0x19e8cb => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x39d89b = profit === 0x0 ? darkMode ? "white" : "black" : profit < 0x0 ? "red" : "green";
  const _0x3f8bb9 = currentstreak === 0x0 ? darkMode ? "white" : "black" : currentstreak < 0x0 ? "red" : 'green';
  const _0x17da15 = maxwinstreak > 0x0 ? "green" : "black";
  document.getElementById("wdbHighWinStreak").style.color = _0x17da15;
  const _0xd2ffc2 = maxlosestreak > 0x0 ? "red" : "black";
  document.getElementById('wdbHighLoseStreak').style.color = _0xd2ffc2;
  ...
  document.getElementById("wdbProfit").style.color = _0x39d89b;
  ...
  document.getElementById("wdbCurrentStreak").style.color = _0x3f8bb9;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x39d89b;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x1d9f3d = game === 'dice' ? bethigh ? '>' : '<' : '>';
    const _0x5b7a58 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x5d5ef3 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x324092 = '<td>' + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x5b7a58 + "</td>\n      <td>" + (game === 'plinko' ? _0x5d5ef3 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === 'plinko' ? _0x5d5ef3 : _0x1d9f3d + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0xa8bff7 = document.createElement('tr');
    if (win) {
      _0xa8bff7.style.backgroundColor = "#91f190";
    } else {
      _0xa8bff7.style.backgroundColor = "#ffc0cb";
    }
    _0xa8bff7.innerHTML = _0x324092;
    document.getElementById("wdbHistory").insertBefore(_0xa8bff7, document.getElementById("wdbHistory").children[0x0]);
    const _0x113cf9 = document.querySelector("#wdbHistory").rows;
    if (_0x113cf9.length > maxRows) {
      document.querySelector("#wdbHistory").lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x4056b5) {
  const _0x4ca4ce = document.getElementById('wdbLog');
  const _0x532cbb = document.createElement('li');
  _0x532cbb.innerText = '' + _0x4056b5;
  document.getElementById("wdbLog").insertBefore(_0x532cbb, _0x4ca4ce.children[0x0]);
  const _0x143571 = _0x4ca4ce.getElementsByTagName('li');
  if (_0x143571.length > maxRows) {
    document.getElementById("wdbLog").removeChild(_0x4ca4ce.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x424f77 => _0x424f77.disabled = true);
      document.querySelectorAll("#wdbOpenScript").forEach(_0x4ba4f5 => _0x4ba4f5.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === "lua") {
        ...
        if (mode === 'js') {
          ...
          let _0x8f7e96 = document.createElement("script");
          _0x8f7e96.id = "wdbRunningScript";
          _0x8f7e96.innerHTML = diceScript;
          document.head.appendChild(_0x8f7e96);
        } else if (mode === "advanced") {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x18a007 => _0x18a007.disabled = false);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x528ac6 => _0x528ac6.disabled = false);
    document.getElementById("wdbStopOnWinButton").disabled = false;
  }
}
async function resume(_0x2d5d1e) {
  if (!run) {
    document.getElementById("wdbMenuCoin").disabled = true;
    document.getElementById('wdbMenuMode').disabled = true;
    document.getElementById("wdbStartButton").disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x5309aa => _0x5309aa.disabled = true);
    document.querySelectorAll('#wdbOpenScript').forEach(_0x1a9bef => _0x1a9bef.disabled = true);
    if (!_0x2d5d1e) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x38654f => setTimeout(_0x38654f, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === 'plinko') {
        const _0x149818 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x1668df = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x149818 + " to win";
        log(_0x1668df);
      } else {
        const _0x5b737f = game === "dice" ? bethigh ? "high" : "low" : "high";
        const _0x3b24fd = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x5b737f;
        log(_0x3b24fd);
      }
    }
    if (run) {
...
function invest(_0x1eb9f0) {
  return _0x1eb9f0;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x394e3d) {
  return new Promise(_0x4d9e0e => setTimeout(_0x4d9e0e, _0x394e3d * 0x3e8));
}
function initLua() {
  ...
  const _0x5191b8 = location.hostname.replace("www.", '');
  let _0x2bbc5e = _0x5191b8.indexOf('.');
  casino = _0x5191b8.slice(0x0, _0x2bbc5e);
...
function randomString(_0x29e72b, _0x410753) {
  const _0x444464 = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  const _0x5bb5e1 = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
  let _0x1ef045 = '';
  let _0x25c78a = '';
  if (!_0x410753) {
    _0x1ef045 = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x444464;
  }
  if (_0x410753 === "alphabet") {
    _0x1ef045 = "abcdefghijklmnopqrstuvwxyz" + _0x444464;
  }
  if (_0x410753 === 'numeric') {
    _0x1ef045 = "0123456789";
  }
  if (_0x410753 === 'hex') {
    _0x1ef045 = "0123456789" + _0x5bb5e1;
  }
  for (let _0x176b80 = 0x0; _0x176b80 < _0x29e72b; _0x176b80++) {
    _0x25c78a += _0x1ef045.charAt(Math.floor(Math.random() * _0x1ef045.length));
  }
  return _0x25c78a;
}
function setCookie(_0x156395, _0x4d8bbb, _0xac5512) {
  const _0x3d148d = new Date();
  _0x3d148d.setTime(_0x3d148d.getTime() + _0xac5512 * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0x5a73a9 = "expires=" + _0x3d148d.toUTCString();
  document.cookie = _0x156395 + '=' + _0x4d8bbb + ';' + _0x5a73a9 + ';path=/';
}
function getCookie(_0x14dc85) {
  _0x14dc85 = _0x14dc85 + '=';
  let _0x5d70d5 = decodeURIComponent(document.cookie);
  let _0x1d08df = _0x5d70d5.split(';');
  for (let _0x396d23 = 0x0; _0x396d23 < _0x1d08df.length; _0x396d23++) {
    let _0x2b8164 = _0x1d08df[_0x396d23];
    while (_0x2b8164.charAt(0x0) === " ") {
      _0x2b8164 = _0x2b8164.substring(0x1);
    }
    if (_0x2b8164.indexOf(_0x14dc85) === 0x0) {
      return _0x2b8164.substring(_0x14dc85.length, _0x2b8164.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x50ac03 = null;
  if (mode === "lua") {
    _0x50ac03 = luaEditor.getValue();
  } else {
    _0x50ac03 = jsEditor.getValue();
  }
  let _0x422326 = document.createElement('a');
  _0x422326.href = window.URL.createObjectURL(new Blob([_0x50ac03], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x422326.download = mode === "lua" ? "DiceScript" + Date.now() + ".lua" : "DiceScript" + Date.now() + ".js";
  _0x422326.click();
}
function getErrMsg(_0x3ed073) {
  const _0x1ec8a8 = _0x3ed073.response && _0x3ed073.response.data && _0x3ed073.response.data.message || _0x3ed073.message || _0x3ed073.toString();
  return _0x1ec8a8;
}
...
async function getListCoin() {
  const _0x382c85 = JSON.stringify({
    'operationName': "UserBalances",
    'query': "query UserBalances {\n      user {\n        balances {\n          available {\n            amount\n            currency\n          }\n        }\n      }\n    }"
  });
  const {
    data: _0x38a8f2
  } = await axios.post(CASINO_API, _0x382c85);
  const _0x26d5fe = _0x38a8f2.data.user.balances;
  for (let _0x56fef7 = 0x0; _0x56fef7 < _0x26d5fe.length; _0x56fef7++) {
    coins.push(String(_0x26d5fe[_0x56fef7].available.currency).toUpperCase());
  }
  coins = coins.sort();
  coin = coins[0x0];
  drawSelectCoin();
...
async function checkbalance() {
  try {
    const _0x19fc66 = JSON.stringify({
      'operationName': 'UserBalances',
      'query': "query UserBalances {\n        user {\n          balances {\n            available {\n              amount\n              currency\n            }\n          }\n        }\n      }"
    });
    const {
      data: _0x4b338e
    } = await axios.post(CASINO_API, _0x19fc66);
    const _0x4d4124 = _0x4b338e.data.user.balances;
    const _0x2896a6 = _0x4d4124.find(_0x193049 => _0x193049.available.currency === String(coin).toLowerCase());
    balance = Number(_0x2896a6.available.amount);
    ...
    stop();
    return log(getErrMsg(_0x274aa2));
  }
}
async function resetseed() {
  try {
    const _0x28f681 = JSON.stringify({
    ...
    return axios.post(CASINO_API, _0x28f681);
  } catch (_0x410279) {
    stop();
    return log(getErrMsg(_0x410279));
  }
}
async function sendBet() {
  try {
    const _0x3c2884 = JSON.stringify({
      'variables': {
        'amount': nextbet,
        'currency': String(coin).toLowerCase(),
    ...
    const {
      data: _0x4467f1
    } = await axios.post(CASINO_API, _0x3c2884);
    if (_0x4467f1.errors) {
      if (_0x4467f1.errors[0x0].message === "an unknown error 294779 has happened.") {
        if (run) {
          return resetseed().then(sendBet);
        }
      } else {
        if (_0x4467f1.errors[0x0].message === "Please choose a new seed pair") {
          if (run) {
            return resetseed().then(sendBet);
          }
        } else {
          if (_0x4467f1.errors[0x0].message === "Please slow down") {
            if (run) {
              return setTimeout(sendBet, 0x3e8);
            }
          } else {
            stop();
            return log(_0x4467f1.errors[0x0].message);
          }
        }
      }
    } else {
      return handleResult(_0x4467f1.data.plinkoBet);
    }
  } catch (_0x425d17) {
    if (_0x425d17.response) {
      const _0x5f0a65 = _0x425d17.response.status;
      if (_0x5f0a65 === 0x190) {
        stop();
        return log(_0x425d17.response.data.errors[0x0].message);
      }
      if (run) {
        return sendBet();
      }
    } else {
      if (_0x425d17.request) {
        if (run) {
          return sendBet();
        }
      } else {
        stop();
        return log(getErrMsg(_0x425d17));
      }
    }
  }
}
async function handleResult(_0x2b2b38) {
  try {
    currentprofit = _0x2b2b38.payout - _0x2b2b38.amount;
    lastBet.nonce = _0x2b2b38.nonce;
    lastBet.id = String(_0x2b2b38.id);
    return handleStats();
  } catch (_0x37fa6b) {
    stop();
    return log(getErrMsg(_0x37fa6b));
  }
}