...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x41f11a => _0x41f11a.style.color = "#fff");
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x200769 => _0x200769.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x57765e) {
  if (_0x57765e.innerText === '▼') {
...
function toggleHideControlBot(_0x56739f) {
  if (_0x56739f.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x209189 = '';
  coins.map(_0x1a7e06 => {
    _0x209189 += "<option value=\"" + _0x1a7e06 + "\">" + _0x1a7e06 + "</option>";
  });
  document.getElementById("wdbMenuCoin").innerHTML = _0x209189;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x345df6 = document.createElement("div");
  _0x345df6.id = "wdbWrap";
  _0x345df6.innerHTML = wdbUI;
  document.body.prepend(_0x345df6);
  const _0xe26d71 = document.getElementById("wdb");
  let _0x1c9058 = 0x0;
  let _0x4b1065 = 0x0;
  let _0x4b2ba6 = 0x0;
  let _0x2d4a86 = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x5d296a;
  } else {
    _0xe26d71.onmousedown = _0x5d296a;
  }
  if (document.getElementById('wdbFooter')) {
    document.getElementById('wdbFooter').onmousedown = _0x5d296a;
  } else {
    _0xe26d71.onmousedown = _0x5d296a;
  }
  function _0x5d296a(_0x3ffc7e) {
    _0x3ffc7e = _0x3ffc7e || window.event;
    _0x3ffc7e.preventDefault();
    _0x4b2ba6 = _0x3ffc7e.clientX;
    _0x2d4a86 = _0x3ffc7e.clientY;
    document.onmouseup = _0x2b19e8;
    document.onmousemove = _0x5453bb;
  }
  function _0x5453bb(_0x5e683c) {
    _0x5e683c = _0x5e683c || window.event;
    _0x5e683c.preventDefault();
    _0x1c9058 = _0x4b2ba6 - _0x5e683c.clientX;
    _0x4b1065 = _0x2d4a86 - _0x5e683c.clientY;
    _0x4b2ba6 = _0x5e683c.clientX;
    _0x2d4a86 = _0x5e683c.clientY;
    _0xe26d71.style.top = _0xe26d71.offsetTop - _0x4b1065 + 'px';
    _0xe26d71.style.left = _0xe26d71.offsetLeft - _0x1c9058 + 'px';
  }
  function _0x2b19e8() {
  ...
  wdbTimer.addEventListener("secondsUpdated", () => {
    const _0x4788b6 = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById('wdbTime').innerText = _0x4788b6;
  });
  ...
  luaFileSelector.addEventListener('change', async _0x3cbaea => {
    const _0x110f06 = await new Response(_0x3cbaea.target.files[0x0]).text();
    if (!_0x110f06) {
      return;
    }
    luaEditor.setValue(_0x110f06);
  });
  ...
  jsFileSelector.addEventListener('change', async _0x1685a2 => {
    const _0x1dac97 = await new Response(_0x1685a2.target.files[0x0]).text();
    if (!_0x1dac97) {
      return;
    }
    jsEditor.setValue(_0x1dac97);
  });
  drawChart();
}
async function wdbLoader(_0x4e9498, _0x4314e7) {
  await _0x4e9498("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
  await _0x4314e7("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
  await _0x4314e7("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x4e9498("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x4e9498("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js");
  await _0x4e9498("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x4e9498(WDB_API + '/' + WDB_MODE + "/lib/chart.js");
  await _0x4e9498(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
  await _0x4e9498(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
  await _0x4e9498(WDB_API + '/' + WDB_MODE + '/lib/ms.js');
  await beforeWork(_0x4e9498);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log("Connected");
...
function selectFunction(_0x3cca16) {
  if (_0x3cca16 === "resetall") {
    resetall();
  }
  if (_0x3cca16 === 'resetstats') {
    resetstats();
  }
  if (_0x3cca16 === "resetchart") {
    toggleChart("reset");
  }
  if (_0x3cca16 === "resethistory") {
    toggleHistory("clear");
  }
  if (_0x3cca16 === "resetlog") {
    toggleLog("clear");
  }
  if (_0x3cca16 === 'resetseed') {
    resetseed();
  }
  if (_0x3cca16 === "stopchart") {
    toggleChart("stop");
  }
  if (_0x3cca16 === "startchart") {
    toggleChart("start");
  }
  if (_0x3cca16 === "stophistory") {
    toggleHistory("stop");
  }
  if (_0x3cca16 === "starthistory") {
    toggleHistory("start");
  }
  if (_0x3cca16 === "stoplog") {
    toggleLog("stop");
  }
  if (_0x3cca16 === "startlog") {
    toggleLog("start");
  }
  if (_0x3cca16 === "hidestats") {
    toggleStats("hide");
  }
  if (_0x3cca16 === "showstats") {
    toggleStats("show");
  }
  if (_0x3cca16 === "hidechart") {
    toggleChart("hide");
  }
  if (_0x3cca16 === "showchart") {
    toggleChart("show");
  }
  if (_0x3cca16 === 'hidehistory') {
    toggleHistory("hide");
  }
  if (_0x3cca16 === "showhistory") {
    toggleHistory("show");
  }
}
function toggleMode(_0x1e18b2) {
  mode = _0x1e18b2;
  if (_0x1e18b2 === "lua") {
...
function toggleHistory(_0x3ab166) {
  if (_0x3ab166 === 'hide') {
...
function toggleLog(_0x2516cd) {
  if (_0x2516cd === "stop") {
    stopLog = true;
  } else {
    if (_0x2516cd === "start") {
      stopLog = false;
    } else if (_0x2516cd === "clear") {
...
async function handleStats() {
  ...
  const _0x54cfb9 = await updateStats();
  const _0x4ae24c = await updateChart();
  const _0x23d55d = await updateHistory();
  Promise.all([_0x54cfb9, _0x4ae24c, _0x23d55d]).then(async _0x597386 => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x270f65 = profit === 0x0 ? darkMode ? "white" : "black" : profit < 0x0 ? 'red' : "green";
  const _0x535595 = currentstreak === 0x0 ? darkMode ? "white" : "black" : currentstreak < 0x0 ? 'red' : "green";
  const _0x4080a5 = maxwinstreak > 0x0 ? "green" : "black";
  document.getElementById('wdbHighWinStreak').style.color = _0x4080a5;
  const _0x1f1399 = maxlosestreak > 0x0 ? 'red' : "black";
  document.getElementById("wdbHighLoseStreak").style.color = _0x1f1399;
  ...
  document.getElementById('wdbProfit').style.color = _0x270f65;
  ...
  document.getElementById('wdbCurrentStreak').style.color = _0x535595;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x270f65;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x100a68 = game === 'dice' ? bethigh ? '>' : '<' : '>';
    const _0x31b3fa = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x3ff2b5 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x33e7dc = '<td>' + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x31b3fa + "</td>\n      <td>" + (game === "plinko" ? _0x3ff2b5 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x3ff2b5 : _0x100a68 + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0x4f670f = document.createElement('tr');
    if (win) {
      _0x4f670f.style.backgroundColor = "#91f190";
    } else {
      _0x4f670f.style.backgroundColor = "#ffc0cb";
    }
    _0x4f670f.innerHTML = _0x33e7dc;
    document.getElementById('wdbHistory').insertBefore(_0x4f670f, document.getElementById('wdbHistory').children[0x0]);
    const _0x45de25 = document.querySelector("#wdbHistory").rows;
    if (_0x45de25.length > maxRows) {
      document.querySelector("#wdbHistory").lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x313cb5) {
  const _0x4c83be = document.getElementById("wdbLog");
  const _0x318119 = document.createElement('li');
  _0x318119.innerText = '' + _0x313cb5;
  document.getElementById("wdbLog").insertBefore(_0x318119, _0x4c83be.children[0x0]);
  const _0x59c065 = _0x4c83be.getElementsByTagName('li');
  if (_0x59c065.length > maxRows) {
    document.getElementById("wdbLog").removeChild(_0x4c83be.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll('#wdbSaveScriptButton').forEach(_0xd7bdc => _0xd7bdc.disabled = true);
      document.querySelectorAll("#wdbOpenScript").forEach(_0x511b11 => _0x511b11.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === 'lua') {
        ...
        if (mode === 'js') {
          ...
          let _0x5cda6f = document.createElement("script");
          _0x5cda6f.id = "wdbRunningScript";
          _0x5cda6f.innerHTML = diceScript;
          document.head.appendChild(_0x5cda6f);
        } else if (mode === "advanced") {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x26f73e => _0x26f73e.disabled = false);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x317bb9 => _0x317bb9.disabled = false);
    document.getElementById('wdbStopOnWinButton').disabled = false;
  }
}
async function resume(_0x288c48) {
  if (!run) {
    document.getElementById('wdbMenuCoin').disabled = true;
    document.getElementById("wdbMenuMode").disabled = true;
    document.getElementById("wdbStartButton").disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x4e1c75 => _0x4e1c75.disabled = true);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x22ba91 => _0x22ba91.disabled = true);
    if (!_0x288c48) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x13ac46 => setTimeout(_0x13ac46, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === "plinko") {
        const _0x4ac9c6 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x56000b = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x4ac9c6 + " to win";
        log(_0x56000b);
      } else {
        const _0x1390be = game === 'dice' ? bethigh ? "high" : "low" : "high";
        const _0x154775 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x1390be;
        log(_0x154775);
      }
    }
    if (run) {
...
function invest(_0x5d5c75) {
  return _0x5d5c75;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x3bada4) {
  return new Promise(_0x3e3d3a => setTimeout(_0x3e3d3a, _0x3bada4 * 0x3e8));
}
function initLua() {
  ...
  const _0x20dd78 = location.hostname.replace("www.", '');
  let _0x52b5dd = _0x20dd78.indexOf('.');
  casino = _0x20dd78.slice(0x0, _0x52b5dd);
...
function randomString(_0x2a8a5e, _0x63fb9) {
  const _0x5c8838 = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  const _0x111ef7 = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
  let _0x4d19e1 = '';
  let _0x811acf = '';
  if (!_0x63fb9) {
    _0x4d19e1 = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x5c8838;
  }
  if (_0x63fb9 === "alphabet") {
    _0x4d19e1 = "abcdefghijklmnopqrstuvwxyz" + _0x5c8838;
  }
  if (_0x63fb9 === "numeric") {
    _0x4d19e1 = '0123456789';
  }
  if (_0x63fb9 === "hex") {
    _0x4d19e1 = '0123456789' + _0x111ef7;
  }
  for (let _0x3d6e5c = 0x0; _0x3d6e5c < _0x2a8a5e; _0x3d6e5c++) {
    _0x811acf += _0x4d19e1.charAt(Math.floor(Math.random() * _0x4d19e1.length));
  }
  return _0x811acf;
}
function setCookie(_0x18f31c, _0x36b6b0, _0x399426) {
  const _0xeb0e82 = new Date();
  _0xeb0e82.setTime(_0xeb0e82.getTime() + _0x399426 * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0x13ec09 = "expires=" + _0xeb0e82.toUTCString();
  document.cookie = _0x18f31c + '=' + _0x36b6b0 + ';' + _0x13ec09 + ';path=/';
}
function getCookie(_0x233cef) {
  _0x233cef = _0x233cef + '=';
  let _0x359da6 = decodeURIComponent(document.cookie);
  let _0x5f47b2 = _0x359da6.split(';');
  for (let _0x471c0c = 0x0; _0x471c0c < _0x5f47b2.length; _0x471c0c++) {
    let _0x32004a = _0x5f47b2[_0x471c0c];
    while (_0x32004a.charAt(0x0) === " ") {
      _0x32004a = _0x32004a.substring(0x1);
    }
    if (_0x32004a.indexOf(_0x233cef) === 0x0) {
      return _0x32004a.substring(_0x233cef.length, _0x32004a.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x1b2cb2 = null;
  if (mode === "lua") {
    _0x1b2cb2 = luaEditor.getValue();
  } else {
    _0x1b2cb2 = jsEditor.getValue();
  }
  let _0x12e8ff = document.createElement('a');
  _0x12e8ff.href = window.URL.createObjectURL(new Blob([_0x1b2cb2], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x12e8ff.download = mode === "lua" ? "DiceScript" + Date.now() + ".lua" : "DiceScript" + Date.now() + ".js";
  _0x12e8ff.click();
}
function getErrMsg(_0x300d0a) {
  const _0x5a24de = _0x300d0a.response && _0x300d0a.response.data && _0x300d0a.response.data.message || _0x300d0a.message || _0x300d0a.toString();
  return _0x5a24de;
}
game = 'limbo';
...
seed = null;
async function beforeWork(_0x22c5a0) {
  await _0x22c5a0(WDB_API + '/' + WDB_MODE + "/lib/sha3.js");
...
async function getListCoin() {
  const _0x1be804 = JSON.stringify({
  ...
  const {
    data: _0x39ec08
  } = await axios.post(CASINO_API, _0x1be804);
  const _0x1478bc = _0x39ec08.data.wallets;
  for (let _0x5345e9 = 0x0; _0x5345e9 < _0x1478bc.length; _0x5345e9++) {
    coins.push(_0x1478bc[_0x5345e9].token.displayName);
  }
  coins = coins.sort();
  coin = coins[0x0];
  drawSelectCoin();
...
async function getMinBet() {
  const _0x1bbd3d = JSON.stringify({
  ...
  return axios.post(CASINO_API, _0x1bbd3d);
}
async function checkbalance() {
  try {
    const _0x1c554e = JSON.stringify({
      'operationName': "wallets",
      'variables': {},
      'query': "query wallets {\n        wallets {\n          availableBalance\n          token {\n            displayName\n          }\n        }\n      }"
    });
    const {
      data: _0x317a98
    } = await axios.post(CASINO_API, _0x1c554e);
    const _0x3e8dd4 = _0x317a98.data.wallets.find(_0x479803 => _0x479803.token.displayName === coin);
    balance = Number(_0x3e8dd4.availableBalance);
    ...
    let _0x5a2bc4 = await getMinBet();
    _0x5a2bc4.data.data.gameSettings.map(_0x4b7f6a => {
      if (coin === "BNB" && _0x4b7f6a.token.tokenCode === 'BSC') {
        minbet = Number(_0x4b7f6a.minimumBet);
        return maxbet = Number(_0x4b7f6a.maximumBet);
      }
      if (_0x4b7f6a.token.tokenCode === coin) {
        minbet = Number(_0x4b7f6a.minimumBet);
        return maxbet = Number(_0x4b7f6a.maximumBet);
      }
    });
    ...
    stop();
    return log(getErrMsg(_0x10811d));
  }
}
function resetseed() {
...
async function sendBet() {
  try {
    const _0xedd7da = randomString(0x20);
    const _0x3b7627 = JSON.stringify({
      'operationName': "commitLimboHash",
      'variables': {
        'hash': sha3_256(_0xedd7da)
      },
      'query': "mutation commitLimboHash($hash: String!) {\n        commitLimboHash(hash: $hash) {\n          stateId\n        }\n      }"
    });
    const _0x301493 = await axios.post(CASINO_API, _0x3b7627);
    const _0x44041a = _0x301493.data.data.commitLimboHash;
    const _0x218b2b = Math.round((0x63 / chance + Number.EPSILON) * 0x64) / 0x64;
    target = _0x218b2b;
    const _0x650402 = JSON.stringify({
      'operationName': "playLimboBet",
      'variables': {
        'bet': {
          'stateId': _0x44041a.stateId,
          'gameId': 'f328060d-781e-46e1-8109-66a6d6f5181d',
          'seed': _0xedd7da,
          'token': coin == 'BNB' ? "BSC" : coin,
          'wager': nextbet.toFixed(0x8),
          'prediction': _0x218b2b,
          'auto': false
        }
      },
      'query': "mutation playLimboBet($bet: LimboBet!) {\n        playLimboBet(bet: $bet) {\n          id\n          payout\n          coefficient\n        }\n      }"
    });
    const {
      data: _0x2a023c
    } = await axios.post(CASINO_API, _0x650402);
    if (_0x2a023c.errors) {
      stop();
      return log(_0x2a023c.errors[0x0].extensions.response.message);
    } else {
      return handleResult(_0x2a023c.data.playLimboBet);
    }
  } catch (_0x137e39) {
    if (_0x137e39.response) {
      const _0x472499 = _0x137e39.response.status;
      if (_0x472499 == 0x0 || _0x472499 >= 0x190) {
        if (run) {
          return sendBet();
        }
      }
      ...
      if (_0x137e39.request) {
        if (run) {
          return sendBet();
        }
      } else {
        stop();
        return log(getErrMsg(_0x137e39));
      }
    }
  }
}
async function handleResult(_0x41ae20) {
  try {
    currentprofit = Number(_0x41ae20.payout) - Number(lastBet.amount);
    lastBet.roll = 0x63 - Number((0x63 / _0x41ae20.coefficient).toFixed(0x2));
    result = _0x41ae20.coefficient;
    lastBet.id = String(_0x41ae20.id);
    return handleStats();
  } catch (_0x35c38e) {
    stop();
    return log(getErrMsg(_0x35c38e));
  }
}