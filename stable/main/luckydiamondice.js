...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x1613ea => _0x1613ea.style.color = "#fff");
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x5733fa => _0x5733fa.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x5a757b) {
  if (_0x5a757b.innerText === '▼') {
...
function toggleHideControlBot(_0x86888f) {
  if (_0x86888f.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x6440da = '';
  coins.map(_0x383845 => {
    _0x6440da += "<option value=\"" + _0x383845 + "\">" + _0x383845 + "</option>";
  });
  document.getElementById("wdbMenuCoin").innerHTML = _0x6440da;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x2d3314 = document.createElement("div");
  _0x2d3314.id = 'wdbWrap';
  _0x2d3314.innerHTML = wdbUI;
  document.body.prepend(_0x2d3314);
  const _0x441a78 = document.getElementById("wdb");
  let _0x284ac9 = 0x0;
  let _0x5823ac = 0x0;
  let _0x556e27 = 0x0;
  let _0x1eb233 = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x2a6997;
  } else {
    _0x441a78.onmousedown = _0x2a6997;
  }
  if (document.getElementById('wdbFooter')) {
    document.getElementById("wdbFooter").onmousedown = _0x2a6997;
  } else {
    _0x441a78.onmousedown = _0x2a6997;
  }
  function _0x2a6997(_0x22017e) {
    _0x22017e = _0x22017e || window.event;
    _0x22017e.preventDefault();
    _0x556e27 = _0x22017e.clientX;
    _0x1eb233 = _0x22017e.clientY;
    document.onmouseup = _0x1cd316;
    document.onmousemove = _0xf3f1f8;
  }
  function _0xf3f1f8(_0x5ce9e1) {
    _0x5ce9e1 = _0x5ce9e1 || window.event;
    _0x5ce9e1.preventDefault();
    _0x284ac9 = _0x556e27 - _0x5ce9e1.clientX;
    _0x5823ac = _0x1eb233 - _0x5ce9e1.clientY;
    _0x556e27 = _0x5ce9e1.clientX;
    _0x1eb233 = _0x5ce9e1.clientY;
    _0x441a78.style.top = _0x441a78.offsetTop - _0x5823ac + 'px';
    _0x441a78.style.left = _0x441a78.offsetLeft - _0x284ac9 + 'px';
  }
  function _0x1cd316() {
  ...
  wdbTimer.addEventListener("secondsUpdated", () => {
    const _0x3b979d = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById("wdbTime").innerText = _0x3b979d;
  });
  ...
  luaFileSelector.addEventListener("change", async _0xee6363 => {
    const _0xe14efb = await new Response(_0xee6363.target.files[0x0]).text();
    if (!_0xe14efb) {
      return;
    }
    luaEditor.setValue(_0xe14efb);
  });
  ...
  jsFileSelector.addEventListener('change', async _0xbf0c8a => {
    const _0x2412d5 = await new Response(_0xbf0c8a.target.files[0x0]).text();
    if (!_0x2412d5) {
      return;
    }
    jsEditor.setValue(_0x2412d5);
  });
  drawChart();
}
async function wdbLoader(_0x5b087b, _0x29a619) {
  await _0x5b087b("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
  await _0x29a619("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
  await _0x29a619('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css');
  await _0x5b087b("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x5b087b("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js");
  await _0x5b087b("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x5b087b(WDB_API + '/' + WDB_MODE + "/lib/chart.js");
  await _0x5b087b(WDB_API + '/' + WDB_MODE + '/lib/easytimer.js');
  await _0x5b087b(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
  await _0x5b087b(WDB_API + '/' + WDB_MODE + '/lib/ms.js');
  await beforeWork(_0x5b087b);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log("Connected");
...
function selectFunction(_0x44bc59) {
  if (_0x44bc59 === 'resetall') {
    resetall();
  }
  if (_0x44bc59 === "resetstats") {
    resetstats();
  }
  if (_0x44bc59 === "resetchart") {
    toggleChart("reset");
  }
  if (_0x44bc59 === "resethistory") {
    toggleHistory("clear");
  }
  if (_0x44bc59 === "resetlog") {
    toggleLog("clear");
  }
  if (_0x44bc59 === "resetseed") {
    resetseed();
  }
  if (_0x44bc59 === "stopchart") {
    toggleChart('stop');
  }
  if (_0x44bc59 === "startchart") {
    toggleChart("start");
  }
  if (_0x44bc59 === "stophistory") {
    toggleHistory("stop");
  }
  if (_0x44bc59 === 'starthistory') {
    toggleHistory("start");
  }
  if (_0x44bc59 === "stoplog") {
    toggleLog('stop');
  }
  if (_0x44bc59 === "startlog") {
    toggleLog("start");
  }
  if (_0x44bc59 === "hidestats") {
    toggleStats("hide");
  }
  if (_0x44bc59 === "showstats") {
    toggleStats('show');
  }
  if (_0x44bc59 === "hidechart") {
    toggleChart('hide');
  }
  if (_0x44bc59 === "showchart") {
    toggleChart("show");
  }
  if (_0x44bc59 === "hidehistory") {
    toggleHistory('hide');
  }
  if (_0x44bc59 === 'showhistory') {
    toggleHistory("show");
  }
}
function toggleMode(_0x1f83e9) {
  mode = _0x1f83e9;
  if (_0x1f83e9 === 'lua') {
...
function toggleHistory(_0x13001b) {
  if (_0x13001b === 'hide') {
...
function toggleLog(_0x3926cd) {
  if (_0x3926cd === "stop") {
    stopLog = true;
  } else {
    if (_0x3926cd === "start") {
      stopLog = false;
    } else if (_0x3926cd === 'clear') {
...
async function handleStats() {
  ...
  const _0x4ae365 = await updateStats();
  const _0x20816e = await updateChart();
  const _0x33c319 = await updateHistory();
  Promise.all([_0x4ae365, _0x20816e, _0x33c319]).then(async _0x482f8a => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x2f0a04 = profit === 0x0 ? darkMode ? "white" : "black" : profit < 0x0 ? "red" : "green";
  const _0x44f125 = currentstreak === 0x0 ? darkMode ? "white" : "black" : currentstreak < 0x0 ? "red" : "green";
  const _0x226be6 = maxwinstreak > 0x0 ? "green" : "black";
  document.getElementById('wdbHighWinStreak').style.color = _0x226be6;
  const _0x2f3f28 = maxlosestreak > 0x0 ? "red" : "black";
  document.getElementById("wdbHighLoseStreak").style.color = _0x2f3f28;
  ...
  document.getElementById("wdbProfit").style.color = _0x2f0a04;
  ...
  document.getElementById("wdbCurrentStreak").style.color = _0x44f125;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x2f0a04;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x53950f = game === "dice" ? bethigh ? '>' : '<' : '>';
    const _0x5f4c00 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x3fd7b1 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x2de707 = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x5f4c00 + "</td>\n      <td>" + (game === 'plinko' ? _0x3fd7b1 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === 'plinko' ? _0x3fd7b1 : _0x53950f + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0x33e12d = document.createElement('tr');
    if (win) {
      _0x33e12d.style.backgroundColor = "#91f190";
    } else {
      _0x33e12d.style.backgroundColor = "#ffc0cb";
    }
    _0x33e12d.innerHTML = _0x2de707;
    document.getElementById("wdbHistory").insertBefore(_0x33e12d, document.getElementById("wdbHistory").children[0x0]);
    const _0x471adc = document.querySelector("#wdbHistory").rows;
    if (_0x471adc.length > maxRows) {
      document.querySelector("#wdbHistory").lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x4dafca) {
  const _0x2d0743 = document.getElementById("wdbLog");
  const _0x232b3a = document.createElement('li');
  _0x232b3a.innerText = '' + _0x4dafca;
  document.getElementById("wdbLog").insertBefore(_0x232b3a, _0x2d0743.children[0x0]);
  const _0x219e20 = _0x2d0743.getElementsByTagName('li');
  if (_0x219e20.length > maxRows) {
    document.getElementById('wdbLog').removeChild(_0x2d0743.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x147d2f => _0x147d2f.disabled = true);
      document.querySelectorAll("#wdbOpenScript").forEach(_0x503fe2 => _0x503fe2.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === "lua") {
        ...
        if (mode === 'js') {
          ...
          let _0x1fec53 = document.createElement("script");
          _0x1fec53.id = "wdbRunningScript";
          _0x1fec53.innerHTML = diceScript;
          document.head.appendChild(_0x1fec53);
        } else if (mode === "advanced") {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0xc67c10 => _0xc67c10.disabled = false);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x4d563e => _0x4d563e.disabled = false);
    document.getElementById("wdbStopOnWinButton").disabled = false;
  }
}
async function resume(_0x2e4271) {
  if (!run) {
    document.getElementById("wdbMenuCoin").disabled = true;
    document.getElementById("wdbMenuMode").disabled = true;
    document.getElementById("wdbStartButton").disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x45d654 => _0x45d654.disabled = true);
    document.querySelectorAll('#wdbOpenScript').forEach(_0x4a3ff0 => _0x4a3ff0.disabled = true);
    if (!_0x2e4271) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x22b3e0 => setTimeout(_0x22b3e0, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === "plinko") {
        const _0x34aa01 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x32239d = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x34aa01 + " to win";
        log(_0x32239d);
      } else {
        const _0x35f822 = game === "dice" ? bethigh ? "high" : "low" : "high";
        const _0x49f52a = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x35f822;
        log(_0x49f52a);
      }
    }
    if (run) {
...
function invest(_0xb5960d) {
  return _0xb5960d;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x148522) {
  return new Promise(_0x2ebe61 => setTimeout(_0x2ebe61, _0x148522 * 0x3e8));
}
function initLua() {
  ...
  const _0x64b5b5 = location.hostname.replace("www.", '');
  let _0x184b86 = _0x64b5b5.indexOf('.');
  casino = _0x64b5b5.slice(0x0, _0x184b86);
...
function randomString(_0x118ead, _0x37c301) {
  const _0x56c3ec = 'abcdefghijklmnopqrstuvwxyz'.toUpperCase();
  const _0x5c97a2 = 'abcdefghijklmnopqrstuvwxyz'.slice(0x0, 0x6);
  let _0x1ea930 = '';
  let _0x1ce961 = '';
  if (!_0x37c301) {
    _0x1ea930 = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x56c3ec;
  }
  if (_0x37c301 === "alphabet") {
    _0x1ea930 = 'abcdefghijklmnopqrstuvwxyz' + _0x56c3ec;
  }
  if (_0x37c301 === "numeric") {
    _0x1ea930 = "0123456789";
  }
  if (_0x37c301 === "hex") {
    _0x1ea930 = "0123456789" + _0x5c97a2;
  }
  for (let _0xad7256 = 0x0; _0xad7256 < _0x118ead; _0xad7256++) {
    _0x1ce961 += _0x1ea930.charAt(Math.floor(Math.random() * _0x1ea930.length));
  }
  return _0x1ce961;
}
function setCookie(_0x346f29, _0x520dd2, _0x2eaefd) {
  const _0x1d82a1 = new Date();
  _0x1d82a1.setTime(_0x1d82a1.getTime() + _0x2eaefd * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0x4f9193 = 'expires=' + _0x1d82a1.toUTCString();
  document.cookie = _0x346f29 + '=' + _0x520dd2 + ';' + _0x4f9193 + ';path=/';
}
function getCookie(_0x811d6b) {
  _0x811d6b = _0x811d6b + '=';
  let _0x1efded = decodeURIComponent(document.cookie);
  let _0x483ac5 = _0x1efded.split(';');
  for (let _0x798dc = 0x0; _0x798dc < _0x483ac5.length; _0x798dc++) {
    let _0x2c4c9c = _0x483ac5[_0x798dc];
    while (_0x2c4c9c.charAt(0x0) === " ") {
      _0x2c4c9c = _0x2c4c9c.substring(0x1);
    }
    if (_0x2c4c9c.indexOf(_0x811d6b) === 0x0) {
      return _0x2c4c9c.substring(_0x811d6b.length, _0x2c4c9c.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x2cff49 = null;
  if (mode === 'lua') {
    _0x2cff49 = luaEditor.getValue();
  } else {
    _0x2cff49 = jsEditor.getValue();
  }
  let _0x56ee36 = document.createElement('a');
  _0x56ee36.href = window.URL.createObjectURL(new Blob([_0x2cff49], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x56ee36.download = mode === 'lua' ? "DiceScript" + Date.now() + ".lua" : "DiceScript" + Date.now() + ".js";
  _0x56ee36.click();
}
function getErrMsg(_0x2be9a4) {
  const _0x38dd8e = _0x2be9a4.response && _0x2be9a4.response.data && _0x2be9a4.response.data.message || _0x2be9a4.message || _0x2be9a4.toString();
  return _0x38dd8e;
}
token = null;
...
async function getListCoin() {
  document.querySelectorAll(".currency-items > div").forEach(_0x21209c => {
    coins.push(_0x21209c.getAttribute("data-currency"));
  });
  coins = coins.sort();
  coin = coins[0x0];
  drawSelectCoin();
...
async function checkbalance() {
  try {
    ...
    const {
      data: _0x4c1a96
    } = await axios.post("/change-currency", _0x1515d5);
    balance = Number(_0x4c1a96.result.balance);
    ...
    for (const _0x347c43 in gameSettings.currencies) {
      if (_0x347c43 === coin) {
        minbet = Number(gameSettings.currencies[_0x347c43].min);
        return maxbet = Number(gameSettings.currencies[_0x347c43].max);
      }
    }
    ...
    return log(getErrMsg(_0x28f15e));
  }
}
async function resetseed() {
  try {
    ...
    const {
      data: _0x32ca78
    } = await axios.post("/api/game-options/change-seeds", _0x48d5f4, {
      'headers': _0x56c9d0
    });
    if (!_0x32ca78.status) {
    ...
    stop();
    return log(getErrMsg(_0x271fd3));
  }
}
async function sendBet() {
  try {
    ...
    const _0xe9c339 = Math.round((0x63 / chance + Number.EPSILON) * 0x64) / 0x64;
    const _0x2a39a3 = {
      'authorization': "Bearer " + token
    };
    const _0x1a43b9 = 'type=%3E&condition=%3' + (bethigh ? 'E' : 'C') + '&currency=' + coin + "&auto=false&autoMore=false&actionOnWin=reset&actionOnLose=reset&amount=" + nextbet.toFixed(0x8) + "&rolls-number=0&roll=" + target.toFixed(0x2) + '&payout=' + _0xe9c339.toFixed(0x4) + "&chance=" + chance.toFixed(0x2) + '&stop-profit=0.00000000&stop-loss=0.00000000&moreOptionsSelectWin=streak&number-win=2&moreOptionsSelectLose=streak&number-lose=2&speed=50&betting=250';
    const {
      data: _0x2ba690
    } = await axios.post("/api/game/dice", _0x1a43b9, {
      'headers': _0x2a39a3
    });
    if (!_0x2ba690.status) {
      stop();
      return log(_0x2ba690.message);
    } else {
      return handleResult(_0x2ba690.result);
    }
  } catch (_0x15c233) {
    if (run) {
      return sendBet();
...
async function handleResult(_0x565267) {
  try {
    currentprofit = _0x565267.profit;
    lastBet.roll = _0x565267.result;
    result = _0x565267.result;
    lastBet.id = String(_0x565267.id);
    return handleStats();
  } catch (_0x6349a9) {
    stop();
    return log(getErrMsg(_0x6349a9));
  }
}
async function getNewToken() {
  try {
    ...
    token = _0x591872.token;
  } catch (_0x54fdd4) {
    stop();
    return log(getErrMsg(_0x54fdd4));
  }
}