...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x52b7cc => _0x52b7cc.style.color = "#bef6fa");
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x4976a1 => _0x4976a1.style.color = "#000");
  }
  updateStats();
}
function toggleMinimalBot(_0x365502) {
  if (_0x365502.innerText === '▼') {
...
function toggleHideControlBot(_0x4fd925) {
  if (_0x4fd925.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x54db26 = '';
  coins.map(_0x4dc4e0 => {
    _0x54db26 += "<option value=\"" + _0x4dc4e0 + "\">" + _0x4dc4e0 + "</option>";
  });
  document.getElementById("wdbMenuCoin").innerHTML = _0x54db26;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x1d5a13 = document.createElement('div');
  _0x1d5a13.id = "wdbWrap";
  _0x1d5a13.innerHTML = wdbUI;
  document.body.prepend(_0x1d5a13);
  const _0x2d968f = document.getElementById("wdb");
  let _0x148387 = 0x0;
  let _0x13eaf5 = 0x0;
  let _0x3ba5dc = 0x0;
  let _0x583aba = 0x0;
  if (document.getElementById('wdbHeader')) {
    document.getElementById("wdbHeader").onmousedown = _0x97daaa;
  } else {
    _0x2d968f.onmousedown = _0x97daaa;
  }
  if (document.getElementById("wdbFooter")) {
    document.getElementById("wdbFooter").onmousedown = _0x97daaa;
  } else {
    _0x2d968f.onmousedown = _0x97daaa;
  }
  function _0x97daaa(_0x5ca08f) {
    _0x5ca08f = _0x5ca08f || window.event;
    _0x5ca08f.preventDefault();
    _0x3ba5dc = _0x5ca08f.clientX;
    _0x583aba = _0x5ca08f.clientY;
    document.onmouseup = _0x3bc6a8;
    document.onmousemove = _0x429318;
  }
  function _0x429318(_0x493322) {
    _0x493322 = _0x493322 || window.event;
    _0x493322.preventDefault();
    _0x148387 = _0x3ba5dc - _0x493322.clientX;
    _0x13eaf5 = _0x583aba - _0x493322.clientY;
    _0x3ba5dc = _0x493322.clientX;
    _0x583aba = _0x493322.clientY;
    _0x2d968f.style.top = _0x2d968f.offsetTop - _0x13eaf5 + 'px';
    _0x2d968f.style.left = _0x2d968f.offsetLeft - _0x148387 + 'px';
  }
  function _0x3bc6a8() {
  ...
  wdbTimer.addEventListener("secondsUpdated", () => {
    const _0x189595 = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById('wdbTime').innerText = _0x189595;
  });
  ...
  luaFileSelector.addEventListener('change', async _0x23dc5b => {
    const _0x12a434 = await new Response(_0x23dc5b.target.files[0x0]).text();
    if (!_0x12a434) {
      return;
    }
    luaEditor.setValue(_0x12a434);
  });
  ...
  jsFileSelector.addEventListener('change', async _0x389d9a => {
    const _0x50d5d5 = await new Response(_0x389d9a.target.files[0x0]).text();
    if (!_0x50d5d5) {
      return;
    }
    jsEditor.setValue(_0x50d5d5);
  });
  drawChart();
}
async function wdbLoader(_0x4a41b2, _0x1bf67b) {
  await _0x4a41b2("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
  await _0x1bf67b("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
  await _0x1bf67b("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x4a41b2("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x4a41b2('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js');
  await _0x4a41b2("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x4a41b2(WDB_API + '/' + WDB_MODE + "/lib/chart.js");
  await _0x4a41b2(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
  await _0x4a41b2(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
  await _0x4a41b2(WDB_API + '/' + WDB_MODE + '/lib/ms.js');
  await beforeWork(_0x4a41b2);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log('Connected');
...
function selectFunction(_0x3fa1af) {
  if (_0x3fa1af === 'resetall') {
    resetall();
  }
  if (_0x3fa1af === "resetstats") {
    resetstats();
  }
  if (_0x3fa1af === "resetchart") {
    toggleChart("reset");
  }
  if (_0x3fa1af === 'resethistory') {
    toggleHistory('clear');
  }
  if (_0x3fa1af === "resetlog") {
    toggleLog('clear');
  }
  if (_0x3fa1af === "resetseed") {
    resetseed();
  }
  if (_0x3fa1af === 'stopchart') {
    toggleChart("stop");
  }
  if (_0x3fa1af === "startchart") {
    toggleChart("start");
  }
  if (_0x3fa1af === "stophistory") {
    toggleHistory("stop");
  }
  if (_0x3fa1af === "starthistory") {
    toggleHistory("start");
  }
  if (_0x3fa1af === "stoplog") {
    toggleLog('stop');
  }
  if (_0x3fa1af === 'startlog') {
    toggleLog("start");
  }
  if (_0x3fa1af === 'hidestats') {
    toggleStats("hide");
  }
  if (_0x3fa1af === "showstats") {
    toggleStats('show');
  }
  if (_0x3fa1af === 'hidechart') {
    toggleChart("hide");
  }
  if (_0x3fa1af === "showchart") {
    toggleChart('show');
  }
  if (_0x3fa1af === "hidehistory") {
    toggleHistory("hide");
  }
  if (_0x3fa1af === 'showhistory') {
    toggleHistory("show");
  }
}
function toggleMode(_0x182d95) {
  mode = _0x182d95;
  if (_0x182d95 === "lua") {
...
function toggleHistory(_0x34de76) {
  if (_0x34de76 === 'hide') {
...
function toggleLog(_0x43994a) {
  if (_0x43994a === "stop") {
    stopLog = true;
  } else {
    if (_0x43994a === "start") {
      stopLog = false;
    } else if (_0x43994a === "clear") {
...
async function handleStats() {
  ...
  const _0x1f2854 = await updateStats();
  const _0x21a0f9 = await updateChart();
  const _0x415afc = await updateHistory();
  Promise.all([_0x1f2854, _0x21a0f9, _0x415afc]).then(async _0x4b0b9e => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x3fc093 = profit === 0x0 ? darkMode ? "white" : "black" : profit < 0x0 ? 'red' : 'green';
  const _0x1b9b22 = currentstreak === 0x0 ? darkMode ? "white" : "black" : currentstreak < 0x0 ? 'red' : 'green';
  const _0x560c08 = maxwinstreak > 0x0 ? 'green' : 'black';
  document.getElementById("wdbHighWinStreak").style.color = _0x560c08;
  const _0x5dad53 = maxlosestreak > 0x0 ? "red" : 'black';
  document.getElementById("wdbHighLoseStreak").style.color = _0x5dad53;
  ...
  document.getElementById("wdbProfit").style.color = _0x3fc093;
  ...
  document.getElementById('wdbCurrentStreak').style.color = _0x1b9b22;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x3fc093;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x5ec57d = game === "dice" ? bethigh ? '>' : '<' : '>';
    const _0x208ad4 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x394162 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x84f7ca = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x208ad4 + "</td>\n      <td>" + (game === "plinko" ? _0x394162 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x394162 : _0x5ec57d + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0x1ded87 = document.createElement('tr');
    if (win) {
      _0x1ded87.style.backgroundColor = '#91f190';
    } else {
      _0x1ded87.style.backgroundColor = "#ffc0cb";
    }
    _0x1ded87.innerHTML = _0x84f7ca;
    document.getElementById("wdbHistory").insertBefore(_0x1ded87, document.getElementById("wdbHistory").children[0x0]);
    const _0x5579e1 = document.querySelector("#wdbHistory").rows;
    if (_0x5579e1.length > maxRows) {
      document.querySelector("#wdbHistory").lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x365655) {
  const _0x111c66 = document.getElementById("wdbLog");
  const _0x3d1092 = document.createElement('li');
  _0x3d1092.innerText = '' + _0x365655;
  document.getElementById("wdbLog").insertBefore(_0x3d1092, _0x111c66.children[0x0]);
  const _0x3355cb = _0x111c66.getElementsByTagName('li');
  if (_0x3355cb.length > maxRows) {
    document.getElementById("wdbLog").removeChild(_0x111c66.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x433bfd => _0x433bfd.disabled = true);
      document.querySelectorAll("#wdbOpenScript").forEach(_0x59fa6b => _0x59fa6b.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === 'lua') {
        ...
        if (mode === 'js') {
          ...
          let _0x1ef21b = document.createElement("script");
          _0x1ef21b.id = 'wdbRunningScript';
          _0x1ef21b.innerHTML = diceScript;
          document.head.appendChild(_0x1ef21b);
        } else if (mode === "advanced") {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x8f8c9d => _0x8f8c9d.disabled = false);
    document.querySelectorAll('#wdbOpenScript').forEach(_0x1862d2 => _0x1862d2.disabled = false);
    document.getElementById('wdbStopOnWinButton').disabled = false;
  }
}
async function resume(_0x25198f) {
  if (!run) {
    document.getElementById("wdbMenuCoin").disabled = true;
    document.getElementById('wdbMenuMode').disabled = true;
    document.getElementById("wdbStartButton").disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x53e080 => _0x53e080.disabled = true);
    document.querySelectorAll('#wdbOpenScript').forEach(_0xae2d1a => _0xae2d1a.disabled = true);
    if (!_0x25198f) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x34f124 => setTimeout(_0x34f124, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === "plinko") {
        const _0x38c3e3 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x227d11 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x38c3e3 + " to win";
        log(_0x227d11);
      } else {
        const _0xc6c030 = game === "dice" ? bethigh ? "high" : "low" : "high";
        const _0x516e09 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0xc6c030;
        log(_0x516e09);
      }
    }
    if (run) {
...
function invest(_0x55ad8a) {
  return _0x55ad8a;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x401a73) {
  return new Promise(_0x1f5307 => setTimeout(_0x1f5307, _0x401a73 * 0x3e8));
}
function initLua() {
  ...
  const _0x1bf231 = location.hostname.replace('www.', '');
  let _0x3c4a59 = _0x1bf231.indexOf('.');
  casino = _0x1bf231.slice(0x0, _0x3c4a59);
...
function randomString(_0x281679, _0x543ddb) {
  const _0x231fbb = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  const _0x1baea9 = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
  let _0x49f40c = '';
  let _0x446321 = '';
  if (!_0x543ddb) {
    _0x49f40c = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x231fbb;
  }
  if (_0x543ddb === "alphabet") {
    _0x49f40c = "abcdefghijklmnopqrstuvwxyz" + _0x231fbb;
  }
  if (_0x543ddb === 'numeric') {
    _0x49f40c = "0123456789";
  }
  if (_0x543ddb === 'hex') {
    _0x49f40c = "0123456789" + _0x1baea9;
  }
  for (let _0x70f085 = 0x0; _0x70f085 < _0x281679; _0x70f085++) {
    _0x446321 += _0x49f40c.charAt(Math.floor(Math.random() * _0x49f40c.length));
  }
  return _0x446321;
}
function setCookie(_0x34844b, _0x224269, _0x5b856d) {
  const _0x3287d2 = new Date();
  _0x3287d2.setTime(_0x3287d2.getTime() + _0x5b856d * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0xd1d034 = "expires=" + _0x3287d2.toUTCString();
  document.cookie = _0x34844b + '=' + _0x224269 + ';' + _0xd1d034 + ";path=/";
}
function getCookie(_0x5857ac) {
  _0x5857ac = _0x5857ac + '=';
  let _0xd3ade0 = decodeURIComponent(document.cookie);
  let _0x547034 = _0xd3ade0.split(';');
  for (let _0x43edc3 = 0x0; _0x43edc3 < _0x547034.length; _0x43edc3++) {
    let _0x526403 = _0x547034[_0x43edc3];
    while (_0x526403.charAt(0x0) === " ") {
      _0x526403 = _0x526403.substring(0x1);
    }
    if (_0x526403.indexOf(_0x5857ac) === 0x0) {
      return _0x526403.substring(_0x5857ac.length, _0x526403.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x47bba9 = null;
  if (mode === 'lua') {
    _0x47bba9 = luaEditor.getValue();
  } else {
    _0x47bba9 = jsEditor.getValue();
  }
  let _0x4449b1 = document.createElement('a');
  _0x4449b1.href = window.URL.createObjectURL(new Blob([_0x47bba9], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x4449b1.download = mode === 'lua' ? "DiceScript" + Date.now() + ".lua" : "DiceScript" + Date.now() + '.js';
  _0x4449b1.click();
}
function getErrMsg(_0x591754) {
  const _0x2e667d = _0x591754.response && _0x591754.response.data && _0x591754.response.data.message || _0x591754.message || _0x591754.toString();
  return _0x2e667d;
}
const _0x4852b8 = _0x5091;
(function (_0x49c958, _0x26c054) {
  const _0x3e39ce = _0x49c958();
  while (true) {
    try {
      const _0x1b58cc = -parseInt(_0x5091(0x236)) / 0x1 * (-parseInt(_0x5091(0x1ee)) / 0x2) + parseInt(_0x5091(0x1f1)) / 0x3 * (parseInt(_0x5091(0x258)) / 0x4) + parseInt(_0x5091(0x259)) / 0x5 * (parseInt(_0x5091(0x20f)) / 0x6) + parseInt(_0x5091(0x235)) / 0x7 + parseInt(_0x5091(0x20a)) / 0x8 * (-parseInt(_0x5091(0x242)) / 0x9) + -parseInt(_0x5091(0x253)) / 0xa + parseInt(_0x5091(0x224)) / 0xb;
      if (_0x1b58cc === _0x26c054) {
        break;
      } else {
        _0x3e39ce.push(_0x3e39ce.shift());
      }
    } catch (_0x5ebf7a) {
      _0x3e39ce.push(_0x3e39ce.shift());
    }
...
game = "plinko";
havePlinkoRows = true;
async function beforeWork(_0x1f4e91) {
  try {
    await _0x1f4e91(WDB_API + '/' + WDB_MODE + "/lib/uuidv4.js");
    await _0x1f4e91(WDB_API + '/' + WDB_MODE + "/lib/fingerprintjs2.js");
    await _0x1f4e91(WDB_API + '/' + WDB_MODE + "/lib/lkb.js");
    await _0x1f4e91(WDB_API + '/' + WDB_MODE + '/lib/mqtt.js');
    connectServer();
    const _0x2f0b9e = {
      'excludes': {
        'audio': true,
    ...
    Fingerprint2.get(_0x2f0b9e, async _0x2d4e3e => {
      const _0x263e28 = _0x2d4e3e.map(_0x4ed669 => {
        if (_0x4ed669.key === "canvas" || _0x4ed669.key === 'webgl' || _0x4ed669.key === 'fonts') {
          _0x4ed669.value = generateHash(_0x4ed669.value);
        }
        return _0x4ed669.value;
      });
      fingerprint = Fingerprint2.x64hash128(_0x263e28.join(''), 0x1f);
...
function resetseed() {
  try {
    ...
    message = new Paho.MQTT.Message(JSON.stringify(_0x55cc2f));
    ...
    message = new Paho.MQTT.Message(JSON.stringify(_0x42eb24));
    message.destinationName = '/n';
    client.send(message);
  } catch (_0x4f3c61) {}
}
async function sendBet() {
  try {
    const _0x35b548 = plinkoRisk === "low" ? "Medium" : plinkoRisk === "medium" ? "High" : 'Ultrahigh';
    const _0xd02923 = {
      'code': 0xfb4,
      'data': {
        'amount': '' + nextbet,
    ...
    message = new Paho.MQTT.Message(JSON.stringify(_0xd02923));
    message.destinationName = '/n';
    client.send(message);
  } catch (_0x47566f) {}
}
async function handleResult(_0x29dd64) {
  try {
    currentprofit = Number(_0x29dd64.win) - Number(_0x29dd64.amount);
    lastBet.id = String(_0x29dd64._id);
    return handleStats();
  } catch (_0x340e5b) {}
}
function _0x1ffe() {
  const _0x49ce4b = ['oVBFV', 'destinationName', 'stringify', 'WXCFk', 'qFoVN', 'aCSED', 'data', '907696zUmilG', 'luckybird', 'dLFnz', 'YIBku', 'tzqgU', '10194dITuLk', 'TBSXj', 'balances', 'sLfmH', 'plinko', 'yrkIO', 'POOlB', 'MPvvB', 'toLowerCase', 'UdbEc', '_id', 'YinFA', 'msg', 'wyfBo', 'subscribe', 'luckybird.io', 'tQrtv', 'Azrdb', 'UWWAt', 'parse', 'amount', '4028552IseChU', 'High', 'ncbYy', 'WZjDL', 'split', 'key', 'value', 'yztKV', 'medium', 'decode', 'XvdII', 'connect', '0.7.7', 'SFacl', 'ZEpkb', '/lib/fingerprintjs2.js', 'log', '3445512dwISxf', '41VjBOKd', 'onConnectionLost', 'GOLD', 'room_id', 'canvas', 'DiGMj', 'plinkoRoll', 'win', 'x64hash128', 'OuuWj', 'minbalance=', 'IZyUC', '90oBSEfl', 'join', 'uid', 'player', 'payloadBytes', 'maxbalance=', 'cZoeQ', 'LmXTe', '/lib/uuidv4.js', 'low', 'getItem', '0|1|2|3|4', 'indexOf', 'USD', 'hex', 'kZImr', 'balance=', '839900BLwemw', '/lib/lkb.js', 'EEyqS', 'qwhOk', 'trim', '16QsHsar', '365TdTuri', 'MQTT', 'zIiUk', "connection lost: ", 'onMessageArrived', '3366lLHgGb', 'send', 'sort', '558933zTjYNr', 'OPjJr', 'errcode', 'code', 'replace', 'Medium', 'errorMessage', 'yTzOV', 'Message', 'token', 'ACBvq', 'numeric', 'get', 'fdJVu', 'load', 'MNkwN', 'Client', 'PgBaV'];
  _0x1ffe = function () {
    return _0x49ce4b;
  };
  return _0x1ffe();
...
async function connectServer() {
  try {
    ...
    client.onConnectionLost = _0x547cb7 => {
      console.log("connection lost: " + _0x547cb7.errorMessage);
    };
    ...
    client.connect(_0x41d971);
  } catch (_0x1b4a4f) {}
}
async function onMessageArrived(_0xdd617e) {
  try {
    _0xdd617e = new TextDecoder().decode(_0xdd617e.payloadBytes);
    const _0x1af6e5 = _0xdd617e.indexOf('{');
    _0xdd617e = _0xdd617e.trim().slice(_0x1af6e5);
    _0xdd617e = _0xdd617e.replace(/'/g, "\"");
    _0xdd617e = JSON.parse(_0xdd617e);
    if (_0xdd617e.code === 0xbc4) {
      const _0x30d372 = _0xdd617e.data.player.balances;
      for (const _0x532169 in _0x30d372) {
        if (_0x532169 === String(coin).toLowerCase()) {
          balance = Number(_0x30d372[_0x532169].amount);
    ...
    if (_0xdd617e.code === 0xbce) {
      roomId = _0xdd617e.data.room_id;
    }
    if (_0xdd617e.code === 0xfb4) {
      if (_0xdd617e.data.errcode !== 0x0) {
        stop();
        return log(_0xdd617e.data.msg);
      }
      return handleResult(_0xdd617e.data.plinkoRoll);
    }
  } catch (_0x10eecd) {}
}
function _0x5091(_0x2b9e09, _0xfbc7fb) {
  const _0x1ffecf = _0x1ffe();
  _0x5091 = function (_0x5091fb, _0x51accf) {
    _0x5091fb = _0x5091fb - 0x1ea;
    let _0x2ae2de = _0x1ffecf[_0x5091fb];
    return _0x2ae2de;
  };
  return _0x5091(_0x2b9e09, _0xfbc7fb);
}
async function initConnect() {
  try {
    const _0x2b0ced = Date.parse(new Date());
    let _0x396e62 = userInfo.token + "luckybird" + _0x2b0ced;
    _0x396e62 = generateKey(_0x396e62).substring(0x0, 0x8);
    let _0x344097 = {
      'code': 0xbc4,
      'data': {
        'is_room': false,
    ...
    message = new Paho.MQTT.Message(JSON.stringify(_0x344097));
    message.destinationName = '/n';
    client.send(message);
    const _0x34c666 = {
      'code': 0xbce,
    ...
    message = new Paho.MQTT.Message(JSON.stringify(_0x34c666));
    message.destinationName = '/n';
    client.send(message);
  } catch (_0x3e7304) {}
}