...
function toggleDarkMode() {
    darkMode = !darkMode;
    if (darkMode) {
        document.getElementById("wdb").style.backgroundColor = '#B12E56';
        ...
        document.querySelector("#wdbWrapVariables pre").style.backgroundColor = '#B12E56';
        document.querySelector("#wdbWrapVariables pre").style.color = "#bef6fa";
        document.querySelector("#wdbWrapFunctions pre").style.backgroundColor = '#B12E56';
        document.querySelector("#wdbWrapFunctions pre").style.color = "#bef6fa";
        document.querySelector("#wdbWrapTips pre").style.backgroundColor = '#B12E56';
        document.querySelector("#wdbWrapTips pre").style.color = "#bef6fa";
        document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x22deb5 => _0x22deb5.style.color = "#bef6fa");
    } else {
        ...
        document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x2f5410 => _0x2f5410.style.color = '#000');
    }
    updateStats();
}
function toggleMinimalBot(_0x1b1921) {
    if (_0x1b1921.innerText === '▼') {
...
function toggleHideControlBot(_0x43d69a) {
    if (_0x43d69a.innerText === '▲') {
...
function drawSelectCoin() {
    let _0x373cca = '';
    coins.map(_0x220ab3 => {
        _0x373cca += "<option value=\"" + _0x220ab3 + "\">" + _0x220ab3 + "</option>";
    });
    document.getElementById('wdbMenuCoin').innerHTML = _0x373cca;
    currency = String(coin).toLowerCase();
    fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
    const _0x9c4232 = document.createElement("div");
    _0x9c4232.id = "wdbWrap";
    _0x9c4232.innerHTML = wdbUI;
    document.body.prepend(_0x9c4232);
    const _0x37caa6 = document.getElementById("wdb");
    let _0x1cb0eb = 0x0;
    let _0x3078ef = 0x0;
    let _0x13763e = 0x0;
    let _0x2d6b30 = 0x0;
    if (document.getElementById("wdbHeader")) {
        document.getElementById("wdbHeader").onmousedown = _0x3bd375;
    } else {
        _0x37caa6.onmousedown = _0x3bd375;
    }
    if (document.getElementById('wdbFooter')) {
        document.getElementById('wdbFooter').onmousedown = _0x3bd375;
    } else {
        _0x37caa6.onmousedown = _0x3bd375;
    }
    function _0x3bd375(_0x10c9ba) {
        _0x10c9ba = _0x10c9ba || window.event;
        _0x10c9ba.preventDefault();
        _0x13763e = _0x10c9ba.clientX;
        _0x2d6b30 = _0x10c9ba.clientY;
        document.onmouseup = _0x1fa71b;
        document.onmousemove = _0x3d1e34;
    }
    function _0x3d1e34(_0x5a7366) {
        _0x5a7366 = _0x5a7366 || window.event;
        _0x5a7366.preventDefault();
        _0x1cb0eb = _0x13763e - _0x5a7366.clientX;
        _0x3078ef = _0x2d6b30 - _0x5a7366.clientY;
        _0x13763e = _0x5a7366.clientX;
        _0x2d6b30 = _0x5a7366.clientY;
        _0x37caa6.style.top = _0x37caa6.offsetTop - _0x3078ef + 'px';
        _0x37caa6.style.left = _0x37caa6.offsetLeft - _0x1cb0eb + 'px';
    }
    function _0x1fa71b() {
    ...
    wdbTimer.addEventListener("secondsUpdated", () => {
        const _0x24a95d = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
        document.getElementById("wdbTime").innerText = _0x24a95d;
    });
    ...
    luaFileSelector.addEventListener("change", async _0x3047cb => {
        const _0x82b70 = await new Response(_0x3047cb.target.files[0x0]).text();
        if (!_0x82b70) {
            return;
        }
        luaEditor.setValue(_0x82b70);
    });
    ...
    jsFileSelector.addEventListener("change", async _0x236837 => {
        const _0xd05fb9 = await new Response(_0x236837.target.files[0x0]).text();
        if (!_0xd05fb9) {
            return;
        }
        jsEditor.setValue(_0xd05fb9);
    });
    drawChart();
}
async function wdbLoader(_0x232398, _0x4a2222) {
    await _0x232398("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
    await _0x4a2222("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
    await _0x4a2222('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css');
    await _0x232398("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
    await _0x232398("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js");
    await _0x232398("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
    await _0x232398(WDB_API + '/' + WDB_MODE + '/lib/chart.js');
    await _0x232398(WDB_API + '/' + WDB_MODE + '/lib/easytimer.js');
    await _0x232398(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
    await _0x232398(WDB_API + '/' + WDB_MODE + "/lib/ms.js");
    await beforeWork(_0x232398);
    await wdbCreateUI();
    await getListCoin();
    initLua();
    log("Connected");
...
function selectFunction(_0x2ac075) {
    if (_0x2ac075 === 'resetall') {
        resetall();
    }
    if (_0x2ac075 === "resetstats") {
        resetstats();
    }
    if (_0x2ac075 === "resetchart") {
        toggleChart("reset");
    }
    if (_0x2ac075 === "resethistory") {
        toggleHistory('clear');
    }
    if (_0x2ac075 === "resetlog") {
        toggleLog('clear');
    }
    if (_0x2ac075 === "resetseed") {
        resetseed();
    }
    if (_0x2ac075 === "stopchart") {
        toggleChart("stop");
    }
    if (_0x2ac075 === 'startchart') {
        toggleChart("start");
    }
    if (_0x2ac075 === 'stophistory') {
        toggleHistory("stop");
    }
    if (_0x2ac075 === "starthistory") {
        toggleHistory("start");
    }
    if (_0x2ac075 === "stoplog") {
        toggleLog("stop");
    }
    if (_0x2ac075 === 'startlog') {
        toggleLog("start");
    }
    if (_0x2ac075 === "hidestats") {
        toggleStats("hide");
    }
    if (_0x2ac075 === 'showstats') {
        toggleStats("show");
    }
    if (_0x2ac075 === "hidechart") {
        toggleChart("hide");
    }
    if (_0x2ac075 === "showchart") {
        toggleChart("show");
    }
    if (_0x2ac075 === 'hidehistory') {
        toggleHistory("hide");
    }
    if (_0x2ac075 === "showhistory") {
        toggleHistory("show");
    }
}
function toggleMode(_0x29fccc) {
    mode = _0x29fccc;
    if (_0x29fccc === "lua") {
...
function toggleHistory(_0x4f0d77) {
    if (_0x4f0d77 === "hide") {
...
function toggleLog(_0xca1215) {
    if (_0xca1215 === "stop") {
        stopLog = true;
    } else {
        if (_0xca1215 === "start") {
            stopLog = false;
        } else if (_0xca1215 === "clear") {
...
async function handleStats() {
    ...
    const _0x55e3dc = await updateStats();
    const _0x37af19 = await updateChart();
    const _0x2093bb = await updateHistory();
    Promise.all([_0x55e3dc, _0x37af19, _0x2093bb]).then(async _0x580a73 => {
        try {
            if (mode === "lua") {
                await updateLua();
            } else {
...
async function updateStats() {
    const _0x1a4818 = profit === 0x0 ? darkMode ? 'white' : "black" : profit < 0x0 ? "red" : 'green';
    const _0x5db8 = currentstreak === 0x0 ? darkMode ? 'white' : "black" : currentstreak < 0x0 ? "red" : 'green';
    const _0x30cc3d = maxwinstreak > 0x0 ? 'green' : "black";
    document.getElementById('wdbHighWinStreak').style.color = _0x30cc3d;
    const _0x33a5dc = maxlosestreak > 0x0 ? "red" : "black";
    document.getElementById("wdbHighLoseStreak").style.color = _0x33a5dc;
    ...
    document.getElementById("wdbProfit").style.color = _0x1a4818;
    ...
    document.getElementById("wdbCurrentStreak").style.color = _0x5db8;
    ...
    document.getElementById('wdbWrapPercentProfit').style.color = _0x1a4818;
...
async function updateHistory() {
    if (!stopHistory) {
        const _0x59fd81 = game === "dice" ? bethigh ? '>' : '<' : '>';
        const _0x46e521 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
        const _0x3a19e1 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x746526 = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x46e521 + "</td>\n      <td>" + (game === "plinko" ? _0x3a19e1 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x3a19e1 : _0x59fd81 + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
        const _0x4ff0a4 = document.createElement('tr');
        if (win) {
            _0x4ff0a4.style.backgroundColor = "#91f190";
        } else {
            _0x4ff0a4.style.backgroundColor = "#ffc0cb";
        }
        _0x4ff0a4.innerHTML = _0x746526;
        document.getElementById("wdbHistory").insertBefore(_0x4ff0a4, document.getElementById("wdbHistory").children[0x0]);
        const _0x50e21e = document.querySelector("#wdbHistory").rows;
        if (_0x50e21e.length > maxRows) {
            document.querySelector("#wdbHistory").lastChild.remove();
        }
    }
    return "updateHistory ok";
}
function log(_0xbdaf93) {
    const _0x12a1a0 = document.getElementById('wdbLog');
    const _0x33bdb7 = document.createElement('li');
    _0x33bdb7.innerText = '' + _0xbdaf93;
    document.getElementById("wdbLog").insertBefore(_0x33bdb7, _0x12a1a0.children[0x0]);
    const _0x281b8d = _0x12a1a0.getElementsByTagName('li');
    if (_0x281b8d.length > maxRows) {
        document.getElementById("wdbLog").removeChild(_0x12a1a0.lastChild);
    }
}
async function start() {
    try {
        if (!run) {
            ...
            document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x3f9b0e => _0x3f9b0e.disabled = true);
            document.querySelectorAll('#wdbOpenScript').forEach(_0x3268ee => _0x3268ee.disabled = true);
            run = true;
            sOW = false;
            wdbTimer.stop();
            wdbTimer.start();
            ...
            if (mode === "lua") {
                ...
                if (mode === 'js') {
                    ...
                    let _0x4ebcc6 = document.createElement('script');
                    _0x4ebcc6.id = "wdbRunningScript";
                    _0x4ebcc6.innerHTML = diceScript;
                    document.head.appendChild(_0x4ebcc6);
                } else if (mode === "advanced") {
...
function stop() {
    if (run) {
        ...
        document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x2915cb => _0x2915cb.disabled = false);
        document.querySelectorAll('#wdbOpenScript').forEach(_0x578c48 => _0x578c48.disabled = false);
        document.getElementById('wdbStopOnWinButton').disabled = false;
    }
}
async function resume(_0x30e223) {
    if (!run) {
        document.getElementById("wdbMenuCoin").disabled = true;
        document.getElementById("wdbMenuMode").disabled = true;
        document.getElementById("wdbStartButton").disabled = true;
        document.getElementById("wdbResumeButton").disabled = true;
        document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x253eb7 => _0x253eb7.disabled = true);
        document.querySelectorAll('#wdbOpenScript').forEach(_0x21616f => _0x21616f.disabled = true);
        if (!_0x30e223) {
            log("Call resume() by script -> betting after 5s");
            await new Promise(_0x3fa306 => setTimeout(_0x3fa306, 0x1388));
        }
        run = true;
        sOW = false;
        wdbSpeed.start();
...
async function playBet() {
    try {
        ...
        if (!stopLog) {
            if (game === 'plinko') {
                const _0x58f0df = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
                const _0x5464b1 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x58f0df + " to win";
                log(_0x5464b1);
            } else {
                const _0xd3cba7 = game === 'dice' ? bethigh ? "high" : "low" : "high";
                const _0x4086d7 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0xd3cba7;
                log(_0x4086d7);
            }
        }
        if (run) {
...
function invest(_0x502b79) {
    return _0x502b79;
}
function ching() {
    return wdbSound.play();
}
function sleep(_0x29560b) {
    return new Promise(_0x599e69 => setTimeout(_0x599e69, _0x29560b * 0x3e8));
}
function initLua() {
    ...
    const _0x40f7db = location.hostname.replace("www.", '');
    let _0xafd32e = _0x40f7db.indexOf('.');
    casino = _0x40f7db.slice(0x0, _0xafd32e);
...
function randomString(_0x461c35, _0x9a53ea) {
    const _0xd67247 = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
    const _0x193f60 = "abcdefghijklmnopqrstuvwxyz".slice(0x0, 0x6);
    let _0x16faab = '';
    let _0x2f999d = '';
    if (!_0x9a53ea) {
        _0x16faab = "0123456789abcdefghijklmnopqrstuvwxyz" + _0xd67247;
    }
    if (_0x9a53ea === 'alphabet') {
        _0x16faab = "abcdefghijklmnopqrstuvwxyz" + _0xd67247;
    }
    if (_0x9a53ea === 'numeric') {
        _0x16faab = "0123456789";
    }
    if (_0x9a53ea === 'hex') {
        _0x16faab = "0123456789" + _0x193f60;
    }
    for (let _0x49548e = 0x0; _0x49548e < _0x461c35; _0x49548e++) {
        _0x2f999d += _0x16faab.charAt(Math.floor(Math.random() * _0x16faab.length));
    }
    return _0x2f999d;
}
function setCookie(_0x5475c8, _0x37dffc, _0xf825ec) {
    const _0x38a58f = new Date();
    _0x38a58f.setTime(_0x38a58f.getTime() + _0xf825ec * 0x18 * 0x3c * 0x3c * 0x3e8);
    let _0x562538 = "expires=" + _0x38a58f.toUTCString();
    document.cookie = _0x5475c8 + '=' + _0x37dffc + ';' + _0x562538 + ";path=/";
}
function getCookie(_0x5d0d99) {
    _0x5d0d99 = _0x5d0d99 + '=';
    let _0x434784 = decodeURIComponent(document.cookie);
    let _0x2484a7 = _0x434784.split(';');
    for (let _0x4b0267 = 0x0; _0x4b0267 < _0x2484a7.length; _0x4b0267++) {
        let _0x444da5 = _0x2484a7[_0x4b0267];
        while (_0x444da5.charAt(0x0) === " ") {
            _0x444da5 = _0x444da5.substring(0x1);
        }
        if (_0x444da5.indexOf(_0x5d0d99) === 0x0) {
            return _0x444da5.substring(_0x5d0d99.length, _0x444da5.length);
        }
    }
    return '';
}
function saveScript() {
    let _0x53f998 = null;
    if (mode === "lua") {
        _0x53f998 = luaEditor.getValue();
    } else {
        _0x53f998 = jsEditor.getValue();
    }
    let _0x353f37 = document.createElement('a');
    _0x353f37.href = window.URL.createObjectURL(new Blob([_0x53f998], {
        'type': "text/plain; charset=utf-8"
    }));
    _0x353f37.download = mode === "lua" ? "DiceScript" + Date.now() + ".lua" : 'DiceScript' + Date.now() + ".js";
    _0x353f37.click();
}
function getErrMsg(_0x5e1390) {
    const _0x46345a = _0x5e1390.response && _0x5e1390.response.data && _0x5e1390.response.data.message || _0x5e1390.message || _0x5e1390.toString();
    return _0x46345a;
}
const _0x3f0333 = _0x1214;
(function (_0x30a930, _0x56b857) {
    const _0x1f61f6 = _0x30a930();
    while (true) {
        try {
            const _0x5b178d = parseInt(_0x1214(0x1cd)) / 0x1 + -parseInt(_0x1214(0x1ca)) / 0x2 + -parseInt(_0x1214(0x1bd)) / 0x3 + -parseInt(_0x1214(0x1a5)) / 0x4 * (-parseInt(_0x1214(0x1a6)) / 0x5) + -parseInt(_0x1214(0x1af)) / 0x6 * (-parseInt(_0x1214(0x188)) / 0x7) + -parseInt(_0x1214(0x1b5)) / 0x8 + parseInt(_0x1214(0x187)) / 0x9;
            if (_0x5b178d === _0x56b857) {
                break;
            } else {
                _0x1f61f6.push(_0x1f61f6.shift());
            }
        } catch (_0x4647e5) {
            _0x1f61f6.push(_0x1f61f6.shift());
        }
...
function _0x5b4e() {
    const _0x2db892 = ['result_value', 'XCaRE', 'XDHIQ', 'value', 'TNQpA', 'request', 'balances', 'EPSILON', 'xjfQx', 'oEXmW', 'load', 'rMuzE', 'push', 'currency', "You can play only one bet at a time.", 'data', 'pcVxA', 'DGJup', 'APtZa', 'length', 'toUpperCase', 'dNncm', 'UwNWO', 'wnowd', 'aQJIu', 'FLDvx', '94936HTXKlQ', '120JFLnNj', 'split', 'XMLHttpRequest', 'defaults', 'message', 'jnmlW', 'dVZQm', 'onpCX', 'headers', '10734AkpmvK', '/api/v1/user/balances', 'szTpu', 'minbalance=', 'token', "Bearer ", '1841680ZzLaHe', 'toFixed', 'sort', 'getItem', 'QgdbB', 'dice', '4|2|5|0|3|1', 'YrmEU', '1394280xgqueY', '/api/v1/dice/manual/play', 'get', 'response', 'hash', 'iTSVw', 'QNMUh', 'bet', 'application/json', 'sweYL', 'profit', 'HBBze', '/api/v1/user/seed/refresh', '457044dJllJp', 'error', 'hEbma', '135769zZbYCs', 'nonce', 'aQuVk', 'ubFCz', 'stringify', 'parse', 'zjnLo', 'round', 'rmaLT', 'jUrDV', 'kMVkU', 'status', 'under', '254367JBWWYI', '2471OiOtiJ', 'xzSZc', 'toLowerCase'];
    _0x5b4e = function () {
        return _0x2db892;
    };
    return _0x5b4e();
...
async function getListCoin() {
    ...
    const _0x35917d = _0x2ab850.balances;
    for (let _0x29786c = 0x0; _0x29786c < _0x35917d.length; _0x29786c++) {
        coins.push(String(_0x35917d[_0x29786c].currency).toUpperCase());
    }
    coins = coins.sort();
    coin = coins[0x0];
    drawSelectCoin();
...
function _0x1214(_0x4e2cc2, _0x14e093) {
    const _0x5b4e01 = _0x5b4e();
    _0x1214 = function (_0x121416, _0x28007b) {
        _0x121416 = _0x121416 - 0x181;
        let _0x5e6609 = _0x5b4e01[_0x121416];
        return _0x5e6609;
    };
    return _0x1214(_0x4e2cc2, _0x14e093);
}
async function checkbalance() {
    try {
        ...
        const _0xa8801a = _0x3bc43f.balances.find(_0x4499d7 => _0x4499d7.currency == String(coin).toLowerCase());
        balance = Number(_0xa8801a.amount);
        ...
        stop();
        return log(getErrMsg(_0x508b9d));
    }
}
async function resetseed() {
    try {
        const _0xa07585 = JSON.stringify({
            'client_seed': randomString(0x14, 'numeric')
        });
        await axios.post("/api/v1/user/seed/refresh", _0xa07585);
        return axios.get('/api/v1/game/seed/refresh');
    } catch (_0x2b0576) {
        stop();
        return log(getErrMsg(_0x2b0576));
    }
}
async function sendBet() {
    try {
        ...
        const _0x53ee2d = Math.round((0x63 / chance + Number.EPSILON) * 0x2710) / 0x2710;
        const _0x3ba5f6 = JSON.stringify({
            'amount': Number(nextbet).toFixed(0x8),
            'auto': 0x1,
            'bet_value': target,
            'currency': String(coin).toLowerCase(),
            'game': "dice",
            'multiplier': _0x53ee2d,
            'rule': bethigh ? 'over' : "under"
        });
        const {
            data: _0x45f74b
        } = await axios.post("/api/v1/dice/manual/play", _0x3ba5f6);
        if (_0x45f74b.error) {
            if (_0x45f74b.error === "You can play only one bet at a time.") {
                if (run) {
                    return sendBet();
                }
            } else {
                stop();
                return log(_0x45f74b.error);
            }
        } else {
            return handleResult(_0x45f74b);
        }
    } catch (_0xdea19) {
        if (_0xdea19.response) {
            const _0x454797 = _0xdea19.response.status;
            if (!_0x454797 || _0x454797 === 0x1ad || _0x454797 >= 0x1f4) {
                if (run) {
                    return sendBet();
                }
            }
            if (_0x454797 >= 0x190 && _0x454797 < 0x1f4) {
                stop();
                const _0x582d02 = _0xdea19.response.data;
                for (const _0x4c2a9c in _0x582d02) {
                    if (_0x4c2a9c === "error") {
                        log(_0x582d02[_0x4c2a9c].message);
                    } else {
                        log(_0x4c2a9c + ": " + _0x582d02[_0x4c2a9c]);
                    }
                }
            }
        } else {
            if (_0xdea19.request) {
                ...
                stop();
                return log(getErrMsg(_0xdea19));
            }
        }
    }
}
async function handleResult(_0x9900ba) {
    try {
        currentprofit = Number(_0x9900ba.bet.profit);
        lastBet.roll = Number(_0x9900ba.bet.result_value);
        result = Number(_0x9900ba.bet.result_value);
        lastBet.nonce = _0x9900ba.bet.nonce;
        lastBet.id = String(_0x9900ba.bet.hash);
        return handleStats();
    } catch (_0x56498b) {
        stop();
        return log(getErrMsg(_0x56498b));
    }
}
