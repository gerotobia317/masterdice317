...
function toggleDarkMode() {
  ...
  if (darkMode) {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0xb2bef5 => _0xb2bef5.style.color = '#bef6fa');
  } else {
    ...
    document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x152fbc => _0x152fbc.style.color = '#000');
  }
  updateStats();
}
function toggleMinimalBot(_0x1cd864) {
  if (_0x1cd864.innerText === '▼') {
...
function toggleHideControlBot(_0x5ddb12) {
  if (_0x5ddb12.innerText === '▲') {
...
function drawSelectCoin() {
  let _0x252fba = '';
  coins.map(_0x595f25 => {
    _0x252fba += "<option value=\"" + _0x595f25 + "\">" + _0x595f25 + "</option>";
  });
  document.getElementById("wdbMenuCoin").innerHTML = _0x252fba;
  currency = String(coin).toLowerCase();
  fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
  const _0x338720 = document.createElement("div");
  _0x338720.id = "wdbWrap";
  _0x338720.innerHTML = wdbUI;
  document.body.prepend(_0x338720);
  const _0x1b653a = document.getElementById("wdb");
  let _0x534bf1 = 0x0;
  let _0xe59f73 = 0x0;
  let _0x4a6081 = 0x0;
  let _0x41b996 = 0x0;
  if (document.getElementById("wdbHeader")) {
    document.getElementById("wdbHeader").onmousedown = _0x4ae9b4;
  } else {
    _0x1b653a.onmousedown = _0x4ae9b4;
  }
  if (document.getElementById('wdbFooter')) {
    document.getElementById('wdbFooter').onmousedown = _0x4ae9b4;
  } else {
    _0x1b653a.onmousedown = _0x4ae9b4;
  }
  function _0x4ae9b4(_0x13a139) {
    _0x13a139 = _0x13a139 || window.event;
    _0x13a139.preventDefault();
    _0x4a6081 = _0x13a139.clientX;
    _0x41b996 = _0x13a139.clientY;
    document.onmouseup = _0x12224d;
    document.onmousemove = _0x1926fe;
  }
  function _0x1926fe(_0x2a8d61) {
    _0x2a8d61 = _0x2a8d61 || window.event;
    _0x2a8d61.preventDefault();
    _0x534bf1 = _0x4a6081 - _0x2a8d61.clientX;
    _0xe59f73 = _0x41b996 - _0x2a8d61.clientY;
    _0x4a6081 = _0x2a8d61.clientX;
    _0x41b996 = _0x2a8d61.clientY;
    _0x1b653a.style.top = _0x1b653a.offsetTop - _0xe59f73 + 'px';
    _0x1b653a.style.left = _0x1b653a.offsetLeft - _0x534bf1 + 'px';
  }
  function _0x12224d() {
  ...
  wdbTimer.addEventListener('secondsUpdated', () => {
    const _0x90704f = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
    document.getElementById("wdbTime").innerText = _0x90704f;
  });
  ...
  luaFileSelector.addEventListener("change", async _0x1938e2 => {
    const _0x1b4b18 = await new Response(_0x1938e2.target.files[0x0]).text();
    if (!_0x1b4b18) {
      return;
    }
    luaEditor.setValue(_0x1b4b18);
  });
  ...
  jsFileSelector.addEventListener("change", async _0x2502c6 => {
    const _0x5b0753 = await new Response(_0x2502c6.target.files[0x0]).text();
    if (!_0x5b0753) {
      return;
    }
    jsEditor.setValue(_0x5b0753);
  });
  drawChart();
}
async function wdbLoader(_0x23cfdc, _0x59907b) {
  await _0x23cfdc("https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js");
  await _0x59907b("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css");
  await _0x59907b("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
  await _0x23cfdc("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
  await _0x23cfdc('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js');
  await _0x23cfdc("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js");
  await _0x23cfdc(WDB_API + '/' + WDB_MODE + "/lib/chart.js");
  await _0x23cfdc(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
  await _0x23cfdc(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
  await _0x23cfdc(WDB_API + '/' + WDB_MODE + "/lib/ms.js");
  await beforeWork(_0x23cfdc);
  await wdbCreateUI();
  await getListCoin();
  initLua();
  log('Connected');
...
function selectFunction(_0x4bd8b0) {
  if (_0x4bd8b0 === 'resetall') {
    resetall();
  }
  if (_0x4bd8b0 === "resetstats") {
    resetstats();
  }
  if (_0x4bd8b0 === "resetchart") {
    toggleChart("reset");
  }
  if (_0x4bd8b0 === 'resethistory') {
    toggleHistory("clear");
  }
  if (_0x4bd8b0 === "resetlog") {
    toggleLog("clear");
  }
  if (_0x4bd8b0 === 'resetseed') {
    resetseed();
  }
  if (_0x4bd8b0 === "stopchart") {
    toggleChart("stop");
  }
  if (_0x4bd8b0 === "startchart") {
    toggleChart('start');
  }
  if (_0x4bd8b0 === "stophistory") {
    toggleHistory("stop");
  }
  if (_0x4bd8b0 === "starthistory") {
    toggleHistory('start');
  }
  if (_0x4bd8b0 === 'stoplog') {
    toggleLog("stop");
  }
  if (_0x4bd8b0 === "startlog") {
    toggleLog('start');
  }
  if (_0x4bd8b0 === "hidestats") {
    toggleStats('hide');
  }
  if (_0x4bd8b0 === "showstats") {
    toggleStats("show");
  }
  if (_0x4bd8b0 === 'hidechart') {
    toggleChart('hide');
  }
  if (_0x4bd8b0 === "showchart") {
    toggleChart("show");
  }
  if (_0x4bd8b0 === "hidehistory") {
    toggleHistory("hide");
  }
  if (_0x4bd8b0 === 'showhistory') {
    toggleHistory("show");
  }
}
function toggleMode(_0x49b22c) {
  mode = _0x49b22c;
  if (_0x49b22c === "lua") {
...
function toggleHistory(_0x394f8e) {
  if (_0x394f8e === "hide") {
...
function toggleLog(_0x5444ce) {
  if (_0x5444ce === "stop") {
    stopLog = true;
  } else {
    if (_0x5444ce === "start") {
      stopLog = false;
    } else if (_0x5444ce === "clear") {
...
async function handleStats() {
  ...
  const _0x11c618 = await updateStats();
  const _0xf62f14 = await updateChart();
  const _0x585f54 = await updateHistory();
  Promise.all([_0x11c618, _0xf62f14, _0x585f54]).then(async _0x4ff6a3 => {
    try {
      if (mode === "lua") {
        await updateLua();
      } else {
...
async function updateStats() {
  const _0x50fb4b = profit === 0x0 ? darkMode ? 'white' : 'black' : profit < 0x0 ? "red" : 'green';
  const _0x345166 = currentstreak === 0x0 ? darkMode ? 'white' : "black" : currentstreak < 0x0 ? "red" : 'green';
  const _0x3d9f0a = maxwinstreak > 0x0 ? 'green' : "black";
  document.getElementById("wdbHighWinStreak").style.color = _0x3d9f0a;
  const _0x3011ab = maxlosestreak > 0x0 ? "red" : "black";
  document.getElementById("wdbHighLoseStreak").style.color = _0x3011ab;
  ...
  document.getElementById("wdbProfit").style.color = _0x50fb4b;
  ...
  document.getElementById("wdbCurrentStreak").style.color = _0x345166;
  ...
  document.getElementById("wdbWrapPercentProfit").style.color = _0x50fb4b;
...
async function updateHistory() {
  if (!stopHistory) {
    const _0x331f55 = game === 'dice' ? bethigh ? '>' : '<' : '>';
    const _0x2a647b = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
    const _0x1c1dc6 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
    const _0x2210b1 = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x2a647b + "</td>\n      <td>" + (game === "plinko" ? _0x1c1dc6 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x1c1dc6 : _0x331f55 + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + "</td>";
    const _0x46c7f5 = document.createElement('tr');
    if (win) {
      _0x46c7f5.style.backgroundColor = "#91f190";
    } else {
      _0x46c7f5.style.backgroundColor = '#ffc0cb';
    }
    _0x46c7f5.innerHTML = _0x2210b1;
    document.getElementById("wdbHistory").insertBefore(_0x46c7f5, document.getElementById("wdbHistory").children[0x0]);
    const _0x4880c0 = document.querySelector('#wdbHistory').rows;
    if (_0x4880c0.length > maxRows) {
      document.querySelector('#wdbHistory').lastChild.remove();
    }
  }
  return "updateHistory ok";
}
function log(_0x277241) {
  const _0xf29e7 = document.getElementById("wdbLog");
  const _0x2db71f = document.createElement('li');
  _0x2db71f.innerText = '' + _0x277241;
  document.getElementById("wdbLog").insertBefore(_0x2db71f, _0xf29e7.children[0x0]);
  const _0x5d885b = _0xf29e7.getElementsByTagName('li');
  if (_0x5d885b.length > maxRows) {
    document.getElementById("wdbLog").removeChild(_0xf29e7.lastChild);
  }
}
async function start() {
  try {
    if (!run) {
      ...
      document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x5aa758 => _0x5aa758.disabled = true);
      document.querySelectorAll('#wdbOpenScript').forEach(_0x278dc0 => _0x278dc0.disabled = true);
      run = true;
      sOW = false;
      wdbTimer.stop();
      wdbTimer.start();
      ...
      if (mode === "lua") {
        ...
        if (mode === 'js') {
          ...
          let _0x2a5eef = document.createElement("script");
          _0x2a5eef.id = "wdbRunningScript";
          _0x2a5eef.innerHTML = diceScript;
          document.head.appendChild(_0x2a5eef);
        } else if (mode === 'advanced') {
...
function stop() {
  if (run) {
    ...
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x56f887 => _0x56f887.disabled = false);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x5da5df => _0x5da5df.disabled = false);
    document.getElementById("wdbStopOnWinButton").disabled = false;
  }
}
async function resume(_0x4ab173) {
  if (!run) {
    document.getElementById("wdbMenuCoin").disabled = true;
    document.getElementById("wdbMenuMode").disabled = true;
    document.getElementById("wdbStartButton").disabled = true;
    document.getElementById("wdbResumeButton").disabled = true;
    document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x36043e => _0x36043e.disabled = true);
    document.querySelectorAll("#wdbOpenScript").forEach(_0x82bb3a => _0x82bb3a.disabled = true);
    if (!_0x4ab173) {
      log("Call resume() by script -> betting after 5s");
      await new Promise(_0x460328 => setTimeout(_0x460328, 0x1388));
    }
    run = true;
    sOW = false;
    wdbSpeed.start();
...
async function playBet() {
  try {
    ...
    if (!stopLog) {
      if (game === "plinko") {
        const _0x106075 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x209c20 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x106075 + " to win";
        log(_0x209c20);
      } else {
        const _0x75fa67 = game === "dice" ? bethigh ? "high" : "low" : "high";
        const _0xee38ce = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x75fa67;
        log(_0xee38ce);
      }
    }
    if (run) {
...
function invest(_0x5e1f74) {
  return _0x5e1f74;
}
function ching() {
  return wdbSound.play();
}
function sleep(_0x2bb472) {
  return new Promise(_0x2d20eb => setTimeout(_0x2d20eb, _0x2bb472 * 0x3e8));
}
function initLua() {
  ...
  const _0x5c3889 = location.hostname.replace('www.', '');
  let _0x4e4e05 = _0x5c3889.indexOf('.');
  casino = _0x5c3889.slice(0x0, _0x4e4e05);
...
function randomString(_0x5718ba, _0x4ddce1) {
  const _0x1c3aca = 'abcdefghijklmnopqrstuvwxyz'.toUpperCase();
  const _0x2c57ac = 'abcdefghijklmnopqrstuvwxyz'.slice(0x0, 0x6);
  let _0x150455 = '';
  let _0xa533e9 = '';
  if (!_0x4ddce1) {
    _0x150455 = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x1c3aca;
  }
  if (_0x4ddce1 === "alphabet") {
    _0x150455 = 'abcdefghijklmnopqrstuvwxyz' + _0x1c3aca;
  }
  if (_0x4ddce1 === 'numeric') {
    _0x150455 = "0123456789";
  }
  if (_0x4ddce1 === "hex") {
    _0x150455 = "0123456789" + _0x2c57ac;
  }
  for (let _0x1b6b86 = 0x0; _0x1b6b86 < _0x5718ba; _0x1b6b86++) {
    _0xa533e9 += _0x150455.charAt(Math.floor(Math.random() * _0x150455.length));
  }
  return _0xa533e9;
}
function setCookie(_0x255f10, _0xb2f6f9, _0x482540) {
  const _0x209636 = new Date();
  _0x209636.setTime(_0x209636.getTime() + _0x482540 * 0x18 * 0x3c * 0x3c * 0x3e8);
  let _0xe87e8c = "expires=" + _0x209636.toUTCString();
  document.cookie = _0x255f10 + '=' + _0xb2f6f9 + ';' + _0xe87e8c + ';path=/';
}
function getCookie(_0x12f058) {
  _0x12f058 = _0x12f058 + '=';
  let _0x3d6594 = decodeURIComponent(document.cookie);
  let _0x412924 = _0x3d6594.split(';');
  for (let _0x29bd9c = 0x0; _0x29bd9c < _0x412924.length; _0x29bd9c++) {
    let _0x12520b = _0x412924[_0x29bd9c];
    while (_0x12520b.charAt(0x0) === " ") {
      _0x12520b = _0x12520b.substring(0x1);
    }
    if (_0x12520b.indexOf(_0x12f058) === 0x0) {
      return _0x12520b.substring(_0x12f058.length, _0x12520b.length);
    }
  }
  return '';
}
function saveScript() {
  let _0x386a6a = null;
  if (mode === "lua") {
    _0x386a6a = luaEditor.getValue();
  } else {
    _0x386a6a = jsEditor.getValue();
  }
  let _0x5c5185 = document.createElement('a');
  _0x5c5185.href = window.URL.createObjectURL(new Blob([_0x386a6a], {
    'type': "text/plain; charset=utf-8"
  }));
  _0x5c5185.download = mode === "lua" ? "DiceScript" + Date.now() + ".lua" : "DiceScript" + Date.now() + ".js";
  _0x5c5185.click();
}
function getErrMsg(_0xdf0145) {
  const _0xc633aa = _0xdf0145.response && _0xdf0145.response.data && _0xdf0145.response.data.message || _0xdf0145.message || _0xdf0145.toString();
  return _0xc633aa;
}
const _0x4d61ef = _0x5f00;
function _0x5f00(_0x36753e, _0x247c87) {
  const _0x174c78 = _0x174c();
  _0x5f00 = function (_0x5f0030, _0x409987) {
    _0x5f0030 = _0x5f0030 - 0xd1;
    let _0xa5b601 = _0x174c78[_0x5f0030];
    return _0xa5b601;
  };
  return _0x5f00(_0x36753e, _0x247c87);
}
function _0x174c() {
  const _0x192a4c = ['4gGOJsw', '9QwVdfS', 'UserBalances', 'minbalance=', '34TkAbhs', 'payout', "mutation PlinkoBet($amount: Float!, $currency: CurrencyEnum!, $risk: CasinoGamePlinkoRiskEnum!, $rows: Int!, $identifier: String!) {\n        plinkoBet(\n          amount: $amount\n          currency: $currency\n          risk: $risk\n          rows: $rows\n          identifier: $identifier\n        ) {\n          ...CasinoBet\n          state {\n            ...CasinoGamePlinko\n          }\n        }\n      }\n      \n      fragment CasinoBet on CasinoBet {\n        id\n        active\n        payoutMultiplier\n        amountMultiplier\n        amount\n        payout\n        updatedAt\n        currency\n        game\n        user {\n          id\n          name\n        }\n      }\n      \n      fragment CasinoGamePlinko on CasinoGamePlinko {\n        risk\n        rows\n        point\n        path\n      }", 'KNeEz', 'uwadk', 'Bhpdu', '3034944cVYMEu', 'user', 'toUpperCase', 'application/json', 'available', 'GqNdF', 'ANYJN', 'session', "Please choose a new seed pair", 'NyFpz', 'keKSx', 'post', 'kufMv', 'StpXP', 'message', 'wfbOu', 'toLowerCase', 'WKiMs', '8930cyknBA', 'request', 'data', 'GrnLO', 'LHtdL', '528595gvtWEa', '/_api/graphql', 'LmvLt', 'stringify', 'IMOkf', '29965kbFoRZ', 'BsmnJ', 'keeWo', '5164232gLZDQb', 'then', 'baWoS', 'errors', "Please slow down", 'amount', 'headers', '1666584ykqOvL', 'jdrLm', 'beZeN', 'push', 'RotateSeedPair', 'qnLgk', 'response', 'balances', 'FLFIB', 'eJpxg', 'sort', "query UserBalances {\n      user {\n        balances {\n          available {\n            amount\n            currency\n          }\n        }\n      }\n    }", '8308909xlRkuh', 'currency', 'wBTxM', 'plinkoBet', 'maxbalance=', 'kClaR', 'kWrTY', 'CEFCB', 'length', 'balance=', 'load', '121oQlwbq'];
  _0x174c = function () {
    return _0x192a4c;
  };
  return _0x174c();
}
(function (_0x43cf04, _0x5e2d2e) {
  const _0xa64ed3 = _0x43cf04();
  while (true) {
    try {
      const _0x1b433d = -parseInt(_0x5f00(0xfe)) / 0x1 * (-parseInt(_0x5f00(0xdc)) / 0x2) + parseInt(_0x5f00(0x108)) / 0x3 + parseInt(_0x5f00(0xd8)) / 0x4 * (-parseInt(_0x5f00(0xf9)) / 0x5) + -parseInt(_0x5f00(0xe2)) / 0x6 + parseInt(_0x5f00(0x114)) / 0x7 + -parseInt(_0x5f00(0x101)) / 0x8 * (parseInt(_0x5f00(0xd9)) / 0x9) + parseInt(_0x5f00(0xf4)) / 0xa * (-parseInt(_0x5f00(0xd7)) / 0xb);
      if (_0x1b433d === _0x5e2d2e) {
        break;
      } else {
        _0xa64ed3.push(_0xa64ed3.shift());
      }
    } catch (_0xdac5c3) {
      _0xa64ed3.push(_0xa64ed3.shift());
    }
...
async function getListCoin() {
  const _0x26f2b0 = JSON.stringify({
    'operationName': "UserBalances",
    'query': "query UserBalances {\n      user {\n        balances {\n          available {\n            amount\n            currency\n          }\n        }\n      }\n    }"
  });
  const {
    data: _0x43467b
  } = await axios.post(CASINO_API, _0x26f2b0);
  const _0x5cecc2 = _0x43467b.data.user.balances;
  for (let _0x30863a = 0x0; _0x30863a < _0x5cecc2.length; _0x30863a++) {
    coins.push(String(_0x5cecc2[_0x30863a].available.currency).toUpperCase());
  }
  coins = coins.sort();
  coin = coins[0x0];
  drawSelectCoin();
...
async function checkbalance() {
  try {
    const _0x5ef7e8 = JSON.stringify({
      'operationName': "UserBalances",
      'query': "query UserBalances {\n        user {\n          balances {\n            available {\n              amount\n              currency\n            }\n          }\n        }\n      }"
    });
    const {
      data: _0x598ac3
    } = await axios.post(CASINO_API, _0x5ef7e8);
    const _0x1c7a93 = _0x598ac3.data.user.balances;
    const _0x42e327 = _0x1c7a93.find(_0x2de771 => _0x2de771.available.currency === String(coin).toLowerCase());
    balance = Number(_0x42e327.available.amount);
    ...
    stop();
    return log(getErrMsg(_0x9a707f));
  }
}
async function resetseed() {
  try {
    const _0x5a18bd = JSON.stringify({
      'operationName': "RotateSeedPair",
      'variables': {
        'seed': randomString(0xa)
      },
      'query': "mutation RotateSeedPair($seed: String!) {\n        rotateSeedPair(seed: $seed) {\n          clientSeed {\n            user {\n              activeClientSeed {\n                seed\n              }\n            }\n          }\n        }\n      }"
    });
    return axios.post(CASINO_API, _0x5a18bd);
  } catch (_0x2ef13e) {
    stop();
    return log(getErrMsg(_0x2ef13e));
  }
}
async function sendBet() {
  try {
    const _0x2e6904 = JSON.stringify({
      'variables': {
        'amount': nextbet,
        'currency': String(coin).toLowerCase(),
        'identifier': randomString(0x14),
        'risk': plinkoRisk,
        'rows': plinkoRow
      },
    ...
    const {
      data: _0x183733
    } = await axios.post(CASINO_API, _0x2e6904);
    if (_0x183733.errors) {
      if (_0x183733.errors[0x0].message === "an unknown error 294779 has happened.") {
        if (run) {
          return resetseed().then(sendBet);
        }
      } else {
        if (_0x183733.errors[0x0].message === "Please choose a new seed pair") {
          if (run) {
            return resetseed().then(sendBet);
          }
        } else {
          if (_0x183733.errors[0x0].message === "Please slow down") {
            if (run) {
              return setTimeout(sendBet, 0x3e8);
            }
          } else {
            stop();
            return log(_0x183733.errors[0x0].message);
          }
        }
      }
    } else {
      return handleResult(_0x183733.data.plinkoBet);
    }
  } catch (_0x4f0d7e) {
    if (_0x4f0d7e.response) {
      const _0x42df37 = _0x4f0d7e.response.status;
      if (_0x42df37 === 0x190) {
        stop();
        return log(_0x4f0d7e.response.data.errors[0x0].message);
      }
      if (run) {
        return sendBet();
      }
    } else {
      if (_0x4f0d7e.request) {
        if (run) {
          return sendBet();
        }
      } else {
        stop();
        return log(getErrMsg(_0x4f0d7e));
      }
    }
  }
}
async function handleResult(_0x5c5c0b) {
  try {
    currentprofit = _0x5c5c0b.payout - _0x5c5c0b.amount;
    lastBet.nonce = _0x5c5c0b.nonce;
    lastBet.id = String(_0x5c5c0b.id);
    return handleStats();
  } catch (_0x3c91dc) {
    stop();
    return log(getErrMsg(_0x3c91dc));
  }
}