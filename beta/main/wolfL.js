...
function toggleDarkMode() {
    ...
    if (darkMode) {
        ...
        document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x3f4d89 => _0x3f4d89.style.color = "#bef6fa");
    } else {
        ...
        document.querySelectorAll("#wdbWrapHistory table thead tr th").forEach(_0x507d65 => _0x507d65.style.color = "#000");
    }
    updateStats();
}
function toggleMinimalBot(_0x4c6e3f) {
    if (_0x4c6e3f.innerText === '▼') {
...
function toggleHideControlBot(_0x19e4c5) {
    if (_0x19e4c5.innerText === '▲') {
...
function drawSelectCoin() {
    let _0x16c68e = '';
    coins.map(_0x1d3303 => {
        _0x16c68e += "<option value=\"" + _0x1d3303 + "\">" + _0x1d3303 + "</option>";
    });
    document.getElementById("wdbMenuCoin").innerHTML = _0x16c68e;
    currency = String(coin).toLowerCase();
    fengari.load("currency=\"" + currency + "\"")();
}
async function wdbCreateUI() {
    const _0x3addec = document.createElement('div');
    _0x3addec.id = 'wdbWrap';
    _0x3addec.innerHTML = wdbUI;
    document.body.prepend(_0x3addec);
    const _0x4ee260 = document.getElementById("wdb");
    let _0x105415 = 0x0;
    let _0x24c7e2 = 0x0;
    let _0x22100c = 0x0;
    let _0x2d10f1 = 0x0;
    if (document.getElementById("wdbHeader")) {
        document.getElementById("wdbHeader").onmousedown = _0x458ee6;
    } else {
        _0x4ee260.onmousedown = _0x458ee6;
    }
    if (document.getElementById("wdbFooter")) {
        document.getElementById("wdbFooter").onmousedown = _0x458ee6;
    } else {
        _0x4ee260.onmousedown = _0x458ee6;
    }
    function _0x458ee6(_0x345997) {
        _0x345997 = _0x345997 || window.event;
        _0x345997.preventDefault();
        _0x22100c = _0x345997.clientX;
        _0x2d10f1 = _0x345997.clientY;
        document.onmouseup = _0x40dbda;
        document.onmousemove = _0x409cc0;
    }
    function _0x409cc0(_0x5039a2) {
        _0x5039a2 = _0x5039a2 || window.event;
        _0x5039a2.preventDefault();
        _0x105415 = _0x22100c - _0x5039a2.clientX;
        _0x24c7e2 = _0x2d10f1 - _0x5039a2.clientY;
        _0x22100c = _0x5039a2.clientX;
        _0x2d10f1 = _0x5039a2.clientY;
        _0x4ee260.style.top = _0x4ee260.offsetTop - _0x24c7e2 + 'px';
        _0x4ee260.style.left = _0x4ee260.offsetLeft - _0x105415 + 'px';
    }
    function _0x40dbda() {
    ...
    wdbTimer.addEventListener("secondsUpdated", () => {
        const _0x219ef7 = wdbTimer.getTimeValues().days + ':' + wdbTimer.getTimeValues().hours + ':' + wdbTimer.getTimeValues().minutes + ':' + wdbTimer.getTimeValues().seconds;
        document.getElementById("wdbTime").innerText = _0x219ef7;
    });
    ...
    luaFileSelector.addEventListener("change", async _0x40c0e3 => {
        const _0x286fd1 = await new Response(_0x40c0e3.target.files[0x0]).text();
        if (!_0x286fd1) {
            return;
        }
        luaEditor.setValue(_0x286fd1);
    });
    ...
    jsFileSelector.addEventListener("change", async _0x1316b6 => {
        const _0x546725 = await new Response(_0x1316b6.target.files[0x0]).text();
        if (!_0x546725) {
            return;
        }
        jsEditor.setValue(_0x546725);
    });
    drawChart();
}
async function wdbLoader(_0x24f976, _0xcef3a4) {
    await _0x24f976('https://cdnjs.cloudflare.com/ajax/libs/axios/1.1.3/axios.min.js');
    await _0xcef3a4('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.css');
    await _0xcef3a4("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/theme/darcula.min.css");
    await _0x24f976("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/codemirror.min.js");
    await _0x24f976("https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/lua/lua.min.js");
    await _0x24f976('https://cdnjs.cloudflare.com/ajax/libs/codemirror/6.65.7/mode/javascript/javascript.min.js');
    await _0x24f976(WDB_API + '/' + WDB_MODE + '/lib/chart.js');
    await _0x24f976(WDB_API + '/' + WDB_MODE + "/lib/easytimer.js");
    await _0x24f976(WDB_API + '/' + WDB_MODE + "/lib/fengari.js");
    await _0x24f976(WDB_API + '/' + WDB_MODE + "/lib/ms.js");
    await beforeWork(_0x24f976);
    await wdbCreateUI();
    await getListCoin();
    initLua();
    log("Connected");
...
function selectFunction(_0x4b0966) {
    if (_0x4b0966 === "resetall") {
        resetall();
    }
    if (_0x4b0966 === 'resetstats') {
        resetstats();
    }
    if (_0x4b0966 === "resetchart") {
        toggleChart("reset");
    }
    if (_0x4b0966 === "resethistory") {
        toggleHistory('clear');
    }
    if (_0x4b0966 === 'resetlog') {
        toggleLog('clear');
    }
    if (_0x4b0966 === "resetseed") {
        resetseed();
    }
    if (_0x4b0966 === 'stopchart') {
        toggleChart('stop');
    }
    if (_0x4b0966 === 'startchart') {
        toggleChart("start");
    }
    if (_0x4b0966 === "stophistory") {
        toggleHistory('stop');
    }
    if (_0x4b0966 === 'starthistory') {
        toggleHistory("start");
    }
    if (_0x4b0966 === "stoplog") {
        toggleLog("stop");
    }
    if (_0x4b0966 === 'startlog') {
        toggleLog("start");
    }
    if (_0x4b0966 === 'hidestats') {
        toggleStats('hide');
    }
    if (_0x4b0966 === "showstats") {
        toggleStats('show');
    }
    if (_0x4b0966 === 'hidechart') {
        toggleChart("hide");
    }
    if (_0x4b0966 === "showchart") {
        toggleChart('show');
    }
    if (_0x4b0966 === "hidehistory") {
        toggleHistory('hide');
    }
    if (_0x4b0966 === "showhistory") {
        toggleHistory('show');
    }
}
function toggleMode(_0x275eb8) {
    mode = _0x275eb8;
    if (_0x275eb8 === "lua") {
...
function toggleHistory(_0x548e15) {
    if (_0x548e15 === "hide") {
...
function toggleLog(_0x1bb853) {
    if (_0x1bb853 === 'stop') {
        stopLog = true;
    } else {
        if (_0x1bb853 === "start") {
            stopLog = false;
        } else if (_0x1bb853 === "clear") {
...
async function handleStats() {
    ...
    const _0x54ab9e = await updateStats();
    const _0x26c367 = await updateChart();
    const _0x12eff7 = await updateHistory();
    Promise.all([_0x54ab9e, _0x26c367, _0x12eff7]).then(async _0xf8e192 => {
        try {
            if (mode === "lua") {
                await updateLua();
            } else {
...
async function updateStats() {
    const _0xb4e9d7 = profit === 0x0 ? darkMode ? "white" : 'black' : profit < 0x0 ? 'red' : "green";
    const _0x51032f = currentstreak === 0x0 ? darkMode ? "white" : "black" : currentstreak < 0x0 ? 'red' : "green";
    const _0x14b076 = maxwinstreak > 0x0 ? "green" : "black";
    document.getElementById('wdbHighWinStreak').style.color = _0x14b076;
    const _0x3fa6eb = maxlosestreak > 0x0 ? 'red' : "black";
    document.getElementById('wdbHighLoseStreak').style.color = _0x3fa6eb;
    ...
    document.getElementById('wdbProfit').style.color = _0xb4e9d7;
    ...
    document.getElementById('wdbCurrentStreak').style.color = _0x51032f;
    ...
    document.getElementById('wdbWrapPercentProfit').style.color = _0xb4e9d7;
...
async function updateHistory() {
    if (!stopHistory) {
        const _0x29b824 = game === "dice" ? bethigh ? '>' : '<' : '>';
        const _0x27ad64 = bethigh ? "<input id=\"bethigh" + bets + "\" type=\"checkbox\" checked />" : "<input id=\"bethigh" + bets + "\" type=\"checkbox\" />";
        const _0x248e77 = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
        const _0x4b3e43 = "<td>" + bets + "</td>\n      <td>" + Number(lastBet.amount).toFixed(decimalAmountView) + "</td>\n      <td>" + _0x27ad64 + "</td>\n      <td>" + (game === 'plinko' ? _0x248e77 : Number(lastBet.chance).toFixed(decimalChanceView)) + "</td>\n      <td>" + Number(lastBet.roll).toFixed(decimalChanceView) + "</td>\n      <td>" + Number(lastBet.profit).toFixed(decimalAmountView) + "</td>\n      <td>" + (game === "plinko" ? _0x248e77 : _0x29b824 + Number(target).toFixed(decimalTargetResult)) + "</td>\n      <td>" + Number(result).toFixed(decimalTargetResult) + "</td>\n      <td>" + lastBet.nonce + "</td>\n      <td>" + lastBet.id + '</td>';
        const _0x4f4b77 = document.createElement('tr');
        if (win) {
            _0x4f4b77.style.backgroundColor = "#91f190";
        } else {
            _0x4f4b77.style.backgroundColor = '#ffc0cb';
        }
        _0x4f4b77.innerHTML = _0x4b3e43;
        document.getElementById("wdbHistory").insertBefore(_0x4f4b77, document.getElementById('wdbHistory').children[0x0]);
        const _0x5c1c66 = document.querySelector("#wdbHistory").rows;
        if (_0x5c1c66.length > maxRows) {
            document.querySelector("#wdbHistory").lastChild.remove();
        }
    }
    return "updateHistory ok";
}
function log(_0x255020) {
    const _0x23293f = document.getElementById("wdbLog");
    const _0xe96b9a = document.createElement('li');
    _0xe96b9a.innerText = '' + _0x255020;
    document.getElementById("wdbLog").insertBefore(_0xe96b9a, _0x23293f.children[0x0]);
    const _0x137631 = _0x23293f.getElementsByTagName('li');
    if (_0x137631.length > maxRows) {
        document.getElementById('wdbLog').removeChild(_0x23293f.lastChild);
    }
}
async function start() {
    try {
        if (!run) {
            ...
            document.querySelectorAll('#wdbSaveScriptButton').forEach(_0x2c546c => _0x2c546c.disabled = true);
            document.querySelectorAll("#wdbOpenScript").forEach(_0x2cf270 => _0x2cf270.disabled = true);
            run = true;
            sOW = false;
            wdbTimer.stop();
            wdbTimer.start();
            ...
            if (mode === 'lua') {
                ...
                if (mode === 'js') {
                    ...
                    let _0x3748cb = document.createElement('script');
                    _0x3748cb.id = 'wdbRunningScript';
                    _0x3748cb.innerHTML = diceScript;
                    document.head.appendChild(_0x3748cb);
                } else if (mode === 'advanced') {
...
function stop() {
    if (run) {
        ...
        document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x2b2efc => _0x2b2efc.disabled = false);
        document.querySelectorAll("#wdbOpenScript").forEach(_0x2053f1 => _0x2053f1.disabled = false);
        document.getElementById("wdbStopOnWinButton").disabled = false;
    }
}
async function resume(_0x2a04fa) {
    if (!run) {
        document.getElementById("wdbMenuCoin").disabled = true;
        document.getElementById('wdbMenuMode').disabled = true;
        document.getElementById("wdbStartButton").disabled = true;
        document.getElementById("wdbResumeButton").disabled = true;
        document.querySelectorAll("#wdbSaveScriptButton").forEach(_0x59d755 => _0x59d755.disabled = true);
        document.querySelectorAll("#wdbOpenScript").forEach(_0x548a77 => _0x548a77.disabled = true);
        if (!_0x2a04fa) {
            log("Call resume() by script -> betting after 5s");
            await new Promise(_0x1f0eb0 => setTimeout(_0x1f0eb0, 0x1388));
        }
        run = true;
        sOW = false;
        wdbSpeed.start();
...
async function playBet() {
    try {
        ...
        if (!stopLog) {
            if (game === "plinko") {
                const _0x26468d = '' + (havePlinkoRows ? plinkoRow + " | " : '') + plinkoRisk;
                const _0x5aa4cc = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + _0x26468d + " to win";
                log(_0x5aa4cc);
            } else {
                const _0x2b4230 = game === "dice" ? bethigh ? 'high' : "low" : 'high';
                const _0x55c607 = "Betting " + Number(lastBet.amount).toFixed(decimalAmountView) + " at " + Number(lastBet.chance).toFixed(decimalChanceView) + "% chance to win, " + _0x2b4230;
                log(_0x55c607);
            }
        }
        if (run) {
...
function invest(_0x33299c) {
    return _0x33299c;
}
function ching() {
    return wdbSound.play();
}
function sleep(_0x6278de) {
    return new Promise(_0x1de54d => setTimeout(_0x1de54d, _0x6278de * 0x3e8));
}
function initLua() {
    ...
    const _0x4c56a3 = location.hostname.replace("www.", '');
    let _0x1d9f53 = _0x4c56a3.indexOf('.');
    casino = _0x4c56a3.slice(0x0, _0x1d9f53);
...
function randomString(_0x227404, _0x4e2cfe) {
    const _0x4ff4fa = 'abcdefghijklmnopqrstuvwxyz'.toUpperCase();
    const _0x3ca03f = 'abcdefghijklmnopqrstuvwxyz'.slice(0x0, 0x6);
    let _0x52ad4c = '';
    let _0x47448e = '';
    if (!_0x4e2cfe) {
        _0x52ad4c = "0123456789abcdefghijklmnopqrstuvwxyz" + _0x4ff4fa;
    }
    if (_0x4e2cfe === "alphabet") {
        _0x52ad4c = 'abcdefghijklmnopqrstuvwxyz' + _0x4ff4fa;
    }
    if (_0x4e2cfe === "numeric") {
        _0x52ad4c = '0123456789';
    }
    if (_0x4e2cfe === 'hex') {
        _0x52ad4c = '0123456789' + _0x3ca03f;
    }
    for (let _0x530f8e = 0x0; _0x530f8e < _0x227404; _0x530f8e++) {
        _0x47448e += _0x52ad4c.charAt(Math.floor(Math.random() * _0x52ad4c.length));
    }
    return _0x47448e;
}
function setCookie(_0x1a2211, _0x330206, _0x4b0b5a) {
    const _0x23141b = new Date();
    _0x23141b.setTime(_0x23141b.getTime() + _0x4b0b5a * 0x18 * 0x3c * 0x3c * 0x3e8);
    let _0x513952 = 'expires=' + _0x23141b.toUTCString();
    document.cookie = _0x1a2211 + '=' + _0x330206 + ';' + _0x513952 + ';path=/';
}
function getCookie(_0x1262cf) {
    _0x1262cf = _0x1262cf + '=';
    let _0x303365 = decodeURIComponent(document.cookie);
    let _0x12c59b = _0x303365.split(';');
    for (let _0x5a8567 = 0x0; _0x5a8567 < _0x12c59b.length; _0x5a8567++) {
        let _0x52acb7 = _0x12c59b[_0x5a8567];
        while (_0x52acb7.charAt(0x0) === " ") {
            _0x52acb7 = _0x52acb7.substring(0x1);
        }
        if (_0x52acb7.indexOf(_0x1262cf) === 0x0) {
            return _0x52acb7.substring(_0x1262cf.length, _0x52acb7.length);
        }
    }
    return '';
}
function saveScript() {
    let _0x260cf9 = null;
    if (mode === "lua") {
        _0x260cf9 = luaEditor.getValue();
    } else {
        _0x260cf9 = jsEditor.getValue();
    }
    let _0x13a0ae = document.createElement('a');
    _0x13a0ae.href = window.URL.createObjectURL(new Blob([_0x260cf9], {
        'type': "text/plain; charset=utf-8"
    }));
    _0x13a0ae.download = mode === 'lua' ? 'DiceScript' + Date.now() + ".lua" : 'DiceScript' + Date.now() + ".js";
    _0x13a0ae.click();
}
function getErrMsg(_0x35d47e) {
    const _0x455ff6 = _0x35d47e.response && _0x35d47e.response.data && _0x35d47e.response.data.message || _0x35d47e.message || _0x35d47e.toString();
    return _0x455ff6;
}
function _0x14c3() {
    const _0x39cbba = ['1121898rAGZBQ', 'xZKII', 'XnrZx', 'AHlhe', '69220jIlOfx', "Bearer ", 'balances', '7022028FyHmdF', 'limbo', 'EPSILON', 'vMaXu', '616055fnNzBO', 'numeric', 'split', 'data', 'KdyCZ', 'balance=', '/api/v1/user/balances', 'FEgxj', 'VFrOC', 'toFixed', 'post', 'JlebC', '103926pOiyLF', 'error', 'Wxmml', '2QLELEe', 'NoeVG', '814AzYReQ', '424nIOuTM', 'round', 'application/json', 'result_value', '91AxHPJh', '12UADgJG', 'SetkK', 'response', 'sEuBX', 'HEsZC', 'VdKfZ', 'bet', 'currency', 'sort', 'TaJHv', 'UqVpS', 'profit', 'maxbalance=', 'XMLHttpRequest', 'defaults', 'amount', 'xddpJ', 'get', 'gGRqh', 'emLgj', 'toUpperCase', 'headers', 'message', 'load', 'EAGRC', 'MUlLf', 'value', 'uxAke', 'FDLHq', 'zTsOv', 'fizXc', 'find', 'parse', 'GIgJn', 'push', '/api/v1/game/seed/refresh', 'UoAUI', 'roll', 'status', '3488cFShdY', '9873quTLiz', 'ACRME', 'nonce', 'toLowerCase', 'stringify', 'length', 'stTuq', 'ULsPd', 'ZCDCV', 'getItem', 'uSOCO', 'request', 'Raycl'];
    _0x14c3 = function () {
        return _0x39cbba;
    };
    return _0x14c3();
}
const _0x1ec6ad = _0x7bf6;
function _0x7bf6(_0x7057c4, _0x4ad8c0) {
    const _0x14c34a = _0x14c3();
    _0x7bf6 = function (_0x7bf65a, _0x5e1550) {
        _0x7bf65a = _0x7bf65a - 0x13e;
        let _0xa166f1 = _0x14c34a[_0x7bf65a];
        return _0xa166f1;
    };
    return _0x7bf6(_0x7057c4, _0x4ad8c0);
}
(function (_0x318eff, _0x326a66) {
    const _0x2f4f8f = _0x318eff();
    while (true) {
        try {
            const _0x57c4b1 = parseInt(_0x7bf6(0x15a)) / 0x1 + -parseInt(_0x7bf6(0x157)) / 0x2 * (parseInt(_0x7bf6(0x194)) / 0x3) + -parseInt(_0x7bf6(0x15f)) / 0x4 * (-parseInt(_0x7bf6(0x148)) / 0x5) + parseInt(_0x7bf6(0x154)) / 0x6 * (-parseInt(_0x7bf6(0x15e)) / 0x7) + parseInt(_0x7bf6(0x186)) / 0x8 * (parseInt(_0x7bf6(0x187)) / 0x9) + -parseInt(_0x7bf6(0x141)) / 0xa * (parseInt(_0x7bf6(0x159)) / 0xb) + parseInt(_0x7bf6(0x144)) / 0xc;
            if (_0x57c4b1 === _0x326a66) {
                break;
            } else {
                _0x2f4f8f.push(_0x2f4f8f.shift());
            }
        } catch (_0x5ba102) {
            _0x2f4f8f.push(_0x2f4f8f.shift());
        }
...
async function getListCoin() {
    ...
    const _0x40161e = _0x16689a.balances;
    for (let _0x1aaf8f = 0x0; _0x1aaf8f < _0x40161e.length; _0x1aaf8f++) {
        coins.push(String(_0x40161e[_0x1aaf8f].currency).toUpperCase());
    }
    coins = coins.sort();
    coin = coins[0x0];
    drawSelectCoin();
...
async function checkbalance() {
    try {
        ...
        const _0x32b886 = _0x4db434.balances.find(_0x5aa0f7 => _0x5aa0f7.currency == String(coin).toLowerCase());
        balance = Number(_0x32b886.amount);
        ...
        stop();
        return log(getErrMsg(_0xf19a55));
    }
}
async function resetseed() {
    try {
        const _0x517c7e = JSON.stringify({
            'client_seed': randomString(0x14, "numeric")
        });
        await axios.post('/api/v1/user/seed/refresh', _0x517c7e);
        return axios.get("/api/v1/game/seed/refresh");
    } catch (_0x389aa7) {
        stop();
        return log(getErrMsg(_0x389aa7));
    }
}
async function sendBet() {
    try {
        ...
        const _0x5fc1ec = JSON.stringify({
        ...
        const {
            data: _0x3f1845
        } = await axios.post('/api/v2/limbo/manual/play', _0x5fc1ec);
        if (_0x3f1845.error) {
            if (_0x3f1845.error === "You can play only one bet at a time.") {
                if (run) {
                    return sendBet();
                }
            } else {
                stop();
                return log(_0x3f1845.error);
            }
        } else {
            return handleResult(_0x3f1845);
        }
    } catch (_0x3254b3) {
        if (_0x3254b3.response) {
            const _0x3f0bbd = _0x3254b3.response.status;
            if (!_0x3f0bbd || _0x3f0bbd === 0x1ad || _0x3f0bbd >= 0x1f4) {
                if (run) {
                    return sendBet();
                }
            }
            if (_0x3f0bbd >= 0x190 && _0x3f0bbd < 0x1f4) {
                stop();
                const _0x4f0822 = _0x3254b3.response.data;
                for (const _0x5d5714 in _0x4f0822) {
                    if (_0x5d5714 === 'error') {
                        log(_0x4f0822[_0x5d5714].message);
                    } else {
                        log(_0x5d5714 + ": " + _0x4f0822[_0x5d5714]);
                    }
                }
            }
        } else {
            if (_0x3254b3.request) {
                if (run) {
                    return sendBet();
                }
            } else {
                stop();
                return log(getErrMsg(_0x3254b3));
            }
        }
    }
}
async function handleResult(_0x2d3096) {
    try {
        currentprofit = Number(_0x2d3096.bet.profit);
        lastBet.roll = 0x63 - Number((0x63 / Number(_0x2d3096.bet.result_value)).toFixed(0x2));
        result = Number(_0x2d3096.bet.result_value);
        lastBet.nonce = _0x2d3096.bet.nonce;
        lastBet.id = String(_0x2d3096.bet.hash);
        return handleStats();
    } catch (_0x9cc708) {
        stop();
        return log(getErrMsg(_0x9cc708));
    }
}